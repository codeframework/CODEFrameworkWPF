...
namespace CODE.Framework.Wpf.Theme.Wildcat.Classes
{
    ...
    public class WildcatButton : Button
    {
        ...
        /// <summary>Defines the position of a button in a group</summary>
        public static void SetPosition(DependencyObject obj, WildcatButtonPosition value) => obj.SetValue(PositionProperty, value);

        /// <summary>Defines the position of a button in a group</summary>
        public static WildcatButtonPosition GetPosition(DependencyObject obj) => (WildcatButtonPosition)obj.GetValue(PositionProperty);
    }
