...
using CODE.Framework.Wpf.Theme.Wildcat.StandardViews;
...
namespace CODE.Framework.Wpf.Theme.Wildcat.Classes
{
    ...
    /// </summary>
    public class WildcatStandardFeatures : IThemeStandardFeatures
    {
        ...
        private readonly IStandardViewFactory _standardViewFactory = new WildcatStandardViewFactory();
    }

    /// <summary>Factory to create standard views supported by Workplace</summary>
    public class WildcatStandardViewFactory : IStandardViewFactory
    {
