...
using CODE.Framework.Wpf.Theme.Zorro.Standard;

namespace CODE.Framework.Wpf.Theme.Zorro.Classes
{
    /// <summary>
    /// Standard features supported by the Zorro theme
    /// </summary>
    public class ZorroStandardFeatures : IThemeStandardFeatures
    {
        ...
        private readonly IStandardViewFactory _standardViewFactory = new ZorroStandardViewFactory();
    }

    /// <summary>Factory to create standard views supported by Zorro</summary>
    public class ZorroStandardViewFactory : IStandardViewFactory
    {
