namespace CODE.Framework.Example.Reference.Models.Home
{
    public class StartViewModel : ViewModel
    {
        ...
        private bool _canLoadMagazines = false;

        public void LoadActions()
        {
            Actions.Clear();

            Actions.Add(new ViewAction("Subscribers", execute: (a, o) => Controller.Action("Subscriber", "List"), canExecute: (a, o) => _canLoadMagazines, significance: ViewActionSignificance.Highest, category: "File", categoryAccessKey: 'F', accessKey: 'S', brushResourceKey: "CODE.Framework-Icon-Contact2") { GroupTitle = "Subscribers", ToolTipText = "Example Tool Tip Text" });
            ...
            Actions.Add(new SwitchThemeViewAction("Workplace", "Workplace", category: "View", categoryAccessKey: 'V', accessKey: 'W') { GroupTitle = "View" });
            Actions.Add(new SwitchThemeViewAction("Metro", "Metro", category: "View", categoryAccessKey: 'V', accessKey: 'M') { GroupTitle = "View" });
            Actions.Add(new SwitchThemeViewAction("Battleship", "Windows 95", category: "View", categoryAccessKey: 'V', accessKey: 'W') { GroupTitle = "View" });
            Actions.Add(new SwitchThemeViewAction("Vapor", "Vapor", category: "View", categoryAccessKey: 'V', accessKey: 'V') { GroupTitle = "View" });
            Actions.Add(new SwitchThemeViewAction("Geek", "Geek", category: "View", categoryAccessKey: 'V', accessKey: 'G') { GroupTitle = "View" });
            ...
            Actions.Add(new SwitchThemeViewAction("Universe", "Universe", category: "View", categoryAccessKey: 'V', accessKey: 'U') { GroupTitle = "View" });
