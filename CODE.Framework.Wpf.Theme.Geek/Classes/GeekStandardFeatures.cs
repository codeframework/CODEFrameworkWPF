...
namespace CODE.Framework.Wpf.Theme.Geek.Classes
{
    ...
    /// </summary>
    public class GeekStandardFeatures : IThemeStandardFeatures
    {
        ...
        private readonly IStandardViewFactory _standardViewFactory = new GeekStandardViewFactory();
    }

    /// <summary>Factory to create standard views supported by Battleship</summary>
    public class GeekStandardViewFactory : IStandardViewFactory
    {
        ...
        /// <returns>Standard view or null</returns>
        public FrameworkElement GetStandardView(Mvvm.StandardViews standardView) => standardView == StandardViews.None ? null : GetStandardView(standardView.ToString());
    }
}
