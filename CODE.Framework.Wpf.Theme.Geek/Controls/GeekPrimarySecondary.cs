...
namespace CODE.Framework.Wpf.Theme.Geek.Controls
{
    ...
    public class GeekPrimarySecondary : GridPrimarySecondary
    {
        ...
        {
            get => (FontFamily)GetValue(PrimaryTitleFontProperty);
        ...
        {
            get => (FontFamily)GetValue(SecondaryTitleFontProperty);
        ...
        {
            get => (double)GetValue(PrimaryTitleFontSizeProperty);
        ...
        {
            get => (double)GetValue(SecondaryTitleFontSizeProperty);
        ...
        {
            get => (Brush)GetValue(PrimaryTitleHeaderBrushProperty);
        ...
        {
            get => (Brush)GetValue(PrimaryTitleFooterBrushProperty);
        ...
        {
            get => (Brush)GetValue(SecondaryTitleHeaderBrushProperty);
        ...
        {
            get => (Brush)GetValue(SecondaryTitleFooterBrushProperty);
        ...
        {
            get => (Brush)GetValue(PrimaryAreaHeaderBackgroundBrushProperty);
        ...
        {
            get => (Brush)GetValue(SecondaryAreaHeaderBackgroundBrushProperty);
        ...
        {
            get => (Thickness)GetValue(PrimaryElementMarginProperty);
        ...
        {
            get => (Thickness)GetValue(SecondaryElementMarginProperty);
        ...
        protected override bool AssignElements(PrimarySecondaryLayout layout, UIElement primary, IEnumerable<UIElement> secondary, bool mustInvalidate)
        {
            ...
            if (primary is FrameworkElement element1) element1.Margin = PrimaryElementMargin;
            if (secondary.FirstOrDefault() is FrameworkElement element2) element2.Margin = SecondaryElementMargin;
            return result;
        }
