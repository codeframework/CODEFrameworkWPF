...
namespace CODE.Framework.Wpf.Documents
{
    ...
    public class FlowDocumentEx : FlowDocument, ISourceInformation, ITitle
    {
        ...
        {
            get => (FrameworkElement)GetValue(PageHeaderProperty);
        ...
        {
            get => (FrameworkElement)GetValue(PageFooterProperty);
        ...
        {
            get => (FrameworkElement)GetValue(PrintWatermarkProperty);
        ...
        {
            get => (Thickness)GetValue(PrintMarginProperty);
