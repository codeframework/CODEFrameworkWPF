...
namespace CODE.Framework.Wpf.Documents
{
    ...
    public class DocumentPaginatorEx : DocumentPaginator
    {
        ...
        public override bool IsPageCountValid => _flowDocumentPaginator != null && _flowDocumentPaginator.IsPageCountValid;
        ...
        {
            get => _flowDocumentPaginator.PageSize;
        ...
        public override IDocumentPaginatorSource Source => _flowDocumentPaginator?.Source;
