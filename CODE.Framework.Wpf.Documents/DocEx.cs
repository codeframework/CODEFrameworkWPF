...
namespace CODE.Framework.Wpf.Documents
{
    ...
    public class DocEx : DependencyObject
    {
        ...
        public static void SetIsItemsHost(DependencyObject target, bool value) => target.SetValue(IsItemsHostProperty, value);
        ...
        public static FrameworkContentElement GetItemsHost(DependencyObject dp)
        {
            ...
            if (dp is FrameworkContentElement element)
                host = element.GetValue(ItemsHostProperty) as FrameworkContentElement ?? element;
            return host;
        }
