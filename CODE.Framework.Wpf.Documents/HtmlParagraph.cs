...
namespace CODE.Framework.Wpf.Documents
{
    ...
    public class HtmlParagraph : Paragraph
    {
        ...
        {
            get => (string)GetValue(LeadingHtmlProperty);
        ...
        {
            get => (string)GetValue(TrailingHtmlProperty);
        ...
        {
            get => (bool)GetValue(TrimLeadingSpacesProperty);
        ...
        {
            get => (bool)GetValue(TrimLeadingTabsProperty);
        ...
        {
            if (source is not HtmlParagraph paragraph) return;
