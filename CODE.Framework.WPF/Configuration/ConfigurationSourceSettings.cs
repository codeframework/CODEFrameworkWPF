namespace CODE.Framework.Wpf.Configuration
{
    /// <summary>
    ...
    public class ConfigurationSourceSettings
    {
        ...
        /// </summary>
        public void ApplyCurrentReadTimestamp() => _lastReadTimestamp = DateTime.Now;
        ...
        public void Add(string key, string value) => this[key] = value; // No lock needed here, since there already is a lock in the indexer
