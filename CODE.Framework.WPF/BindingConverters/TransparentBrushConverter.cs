...
namespace CODE.Framework.Wpf.BindingConverters
{
    ...
    /// </summary>
    public class TransparentBrushConverter : IValueConverter
    {
        /// <summary>
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            return new SolidColorBrush(Color.FromArgb(transparency, originalColor.R, originalColor.G, originalColor.B));
        }
        ...
        /// A converted value. If the method returns null, the valid null value is used.
        /// </returns>
        public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture) => null; // Not needed
    }
}
