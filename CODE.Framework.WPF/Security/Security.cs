...
namespace CODE.Framework.Wpf.Security
{
    ...
    public class Security : DependencyObject
    {
        ...
        /// </summary>
        public static string GetReadOnlyRoles(DependencyObject d) => (string)d.GetValue(ReadOnlyRolesProperty);
        /// <summary>
        /// Defines the roles the current user has to be in to be granted read-only access to the control this applies to
        /// </summary>
        public static void SetReadOnlyRoles(DependencyObject d, string value) => d.SetValue(ReadOnlyRolesProperty, value);
        ...
        /// </summary>
        public static string GetFullAccessRoles(DependencyObject d) => (string)d.GetValue(FullAccessRolesProperty);
        /// <summary>
        /// Defines the roles the current user has to be in to be granted full access to the control this applies to
        /// </summary>
        public static void SetFullAccessRoles(DependencyObject d, string value) => d.SetValue(FullAccessRolesProperty, value);
