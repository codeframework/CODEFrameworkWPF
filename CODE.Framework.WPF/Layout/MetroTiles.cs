...
namespace CODE.Framework.Wpf.Layout
{
    ...
    public class MetroTiles : Panel
    {
        ...
        {
            get => (TileWidthModes)GetValue(DefaultTileWidthProperty);
        ...
        {
            get => (Size)GetValue(ContentTopLeftPaddingProperty);
        ...
        {
            get => (bool)GetValue(RenderHeadersProperty);
        ...
        {
            get => (AutoLayoutHeaderRenderer)GetValue(HeaderRendererProperty); 
        ...
        /// <summary>Get operation for GroupTitleProperty dependency property</summary><param name="obj">The object the property really belongs to</param><returns>Actual property value.</returns>
        public static TileWidthModes GetTileWidthMode(DependencyObject obj) => (TileWidthModes)obj.GetValue(TileWidthModeProperty);
        ...
        public static double GetTileHeight(DependencyObject obj) => (double)obj.GetValue(TileHeightProperty);
        ...
        public static Visibility GetTileVisibility(DependencyObject obj) => (Visibility)obj.GetValue(TileVisibilityProperty);
        ...
        public static void SetTileVisibility(DependencyObject obj, Visibility value) => obj.SetValue(TileVisibilityProperty, value);

        /// <summary>Get operation for TileHeightProperty dependency property</summary><param name="obj">The object the property really belongs to</param><returns>Actual property value.</returns>
        public static double GetTileWidth(DependencyObject obj) => (double)obj.GetValue(TileWidthProperty);
        ...
        public static double GetHorizontalTileSpacing(DependencyObject obj) => (double)obj.GetValue(HorizontalTileSpacingProperty);
        ...
        public static double GetVerticalTileSpacing(DependencyObject obj) => (double)obj.GetValue(VerticalTileSpacingProperty);
        ...
        /// <summary>Get operation for HorizontalTileSpacingProperty dependency property</summary><param name="obj">The object the property really belongs to</param><returns>Actual property value.</returns>
        public static double GetHorizontalGroupSpacing(DependencyObject obj) => (double)obj.GetValue(HorizontalGroupSpacingProperty);
        ...
        {
            if (dependencyObject is MetroTiles panel)
            {
        ...
        /// </returns>
        protected override Size MeasureOverride(Size availableSize) => IterateChildren(availableSize, (child, rect) => child.Measure(rect.Size));
            ...
            try
            {
                ...
                foreach (var group in groups.Values)
                {
                    ...
                    foreach (var child in group)
                    {
                        ...
                        if (child is ContentPresenter contentPresenter && contentPresenter.Content != null && contentPresenter.Content is DependencyObject)
                        {
        ...
        private string GetGroupNameForObject(DependencyObject d)
        {
            ...
            if (string.IsNullOrEmpty(group) && d is ContentPresenter && ((ContentPresenter)d).Content is DependencyObject dependencyContent)
