...
namespace CODE.Framework.Wpf.Layout
{
    ...
    public class DockContainer : Panel
    {
        ...
        /// <summary>List of UI elements used in the main dock well</summary>
        public List<DockedUIElement> MainDockWell => _mainDockWell;
        ...
        /// <summary>List of UI elements used in the secondary dock well</summary>
        public List<DockedUIElement> SecondaryDockWell => _secondaryDockWell;
        ...
        public static DockPosition GetDockPosition(DependencyObject obj) => (DockPosition)obj.GetValue(DockPositionProperty);

        /// <summary>Sets the dock position. </summary>
        /// <param name="obj">The object.</param>
        /// <param name="value">The value.</param>
        public static void SetDockPosition(DependencyObject obj, DockPosition value) => obj.SetValue(DockPositionProperty, value);
        ...
        {
            get => (double)GetValue(SplitterHeightProperty);
        ...
        {
            get => (IDockWellRenderer)GetValue(DockWellRendererProperty);
        ...
        {
            if (d is not DockContainer container) return;
        ...
        private static Rect ReducedClientRect(Rect original) => GeometryHelper.NewRect(original.X + 1, original.Y + 1, original.Width - 2, original.Height - 2);

        private static Size ReducedClientSize(Size original) => GeometryHelper.NewSize(original.Width - 2, original.Height - 2);
        ...
        {
            get => (double)GetValue(LeftDockWidthProperty);
        ...
        {
            get => (double)GetValue(RightDockWidthProperty);
        ...
        {
            get => (double)GetValue(TopDockHeightProperty);
        ...
        {
            get => (double)GetValue(BottomDockHeightProperty);
        ...
        {
            get => (int)GetValue(MainDockSelectedIndexProperty);
        ...
        {
            get => (int)GetValue(LeftDockSelectedIndexProperty);
        ...
        {
            get => (int)GetValue(RightDockSelectedIndexProperty);
        ...
        {
            get => (int)GetValue(TopDockSelectedIndexProperty);
        ...
        {
            get => (int)GetValue(BottomDockSelectedIndexProperty);
        ...
        public void AddHotArea(HotArea hotArea) => _hotAreas.Add(hotArea);
    ...
    public class StandardDockWellRenderer : FrameworkElement, IDockWellRenderer
    {
        ...
        /// </summary>
        /// <param name="container">Container</param>
        public void SetDockContainer(DockContainer container) => _parent = container;
        ...
        /// <param name="showTabs">Defines whether tabs headers should be shown.</param>
        /// <param name="firstTabOffset">In special cases, the first tab may be offset by a certain margin</param>
        public void DrawDockWindowChrome(DrawingContext dc, List<DockedUIElement> elements, int selectedIndex, Rect clientRect, bool showTabs, Point firstTabOffset) => DrawDockWellChrome(dc, elements, clientRect, selectedIndex, showTabs, firstTabOffset);
        ...
        {
            get => (Brush)GetValue(MainWellHeaderBackgroundBrushProperty);
        ...
        {
            get => (Brush)GetValue(MainWellBorderBrushProperty);
        ...
        {
            get => (Brush)GetValue(DockWellBorderBrushProperty);
        ...
        {
            get => (Brush)GetValue(DockWellSelectedFooterBackgroundBrushProperty);
        ...
        {
            get => (Brush)GetValue(MainWellHeaderForegroundBrushProperty);
        ...
        {
            get => (Brush)GetValue(DockWellHeaderFlourishBrushProperty);
        ...
        {
            get => (Brush)GetValue(DockWellHeaderBackgroundBrushProperty);
        ...
        {
            get => (Brush)GetValue(DockWellActivePageBackgroundBrushProperty);
        ...
        {
            get => (Brush)GetValue(DockWellHeaderForegroundBrushProperty);
        ...
        {
            get => (Brush)GetValue(DockWellFooterForegroundBrushProperty);
        ...
        {
            get => (Brush)GetValue(DockWellSelectedFooterForegroundBrushProperty);
        ...
        {
            get => (Brush)GetValue(MainWellSelectedHeaderForegroundBrushProperty); 
        ...
        {
            get => (double)GetValue(MainWellHeaderFontSizeProperty);
        ...
        {
            get => (FontFamily)GetValue(MainWellHeaderFontFamilyProperty);
        ...
        {
            get => (FontStyle)GetValue(MainWellHeaderFontStyleProperty);
        ...
        {
            get => (FontWeight)GetValue(MainWellHeaderFontWeightProperty);
        ...
        {
            get => (double)GetValue(DockWellHeaderFontSizeProperty);
        ...
        {
            get => (FontFamily)GetValue(DockWellHeaderFontFamilyProperty);
        ...
        {
            get => (FontStyle)GetValue(DockWellHeaderFontStyleProperty);
        ...
        {
            get => (FontWeight)GetValue(DockWellHeaderFontWeightProperty);
        ...
        {
            get => (double)GetValue(DockWellFooterFontSizeProperty);
        ...
        {
            get => (FontFamily)GetValue(DockWellFooterFontFamilyProperty);
        ...
        {
            get => (FontStyle)GetValue(DockWellFooterFontStyleProperty);
        ...
        {
            get => (FontWeight)GetValue(DockWellFooterFontWeightProperty);
    ...
    public class DockWellFloatWindow : Window
    {
        ...
        protected override Size MeasureOverride(Size availableSize)
        {
            if (Content is UIElement element && ActualHeight > 0d && ActualWidth > 0d)
            {
