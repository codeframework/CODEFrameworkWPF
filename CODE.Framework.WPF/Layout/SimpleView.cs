...
namespace CODE.Framework.Wpf.Layout
{
    ...
    public class SimpleView : ItemsControl, IUserInterfaceActivation
    {
        ...
        {
            if (s is not SimpleView view) return;
            view.TitleChanged?.Invoke(s, new EventArgs());
        }));
        ...
        /// <summary>Indicates whether an element can be independently closed</summary>
        ...
        /// <summary>
        ///     <summary>Indicates the relative width of an element compared to other elements</summary>
        /// </summary>
        ...
        /// <summary>
        ///     <summary>Indicates the relative height of an element compared to other elements</summary>
        /// </summary>
        ...
        /// <summary>Location this view was originally loaded from</summary>
        /// <value></value>
        public string OriginalViewLoadLocation { get; set; }

        /// <summary>Occurs when the user interface got activated</summary>
        public event EventHandler Activated;

        /// <summary>Raises the activated events.</summary>
        /// <exception cref="System.NotImplementedException"></exception>
        public void RaiseActivated() => Activated?.Invoke(this, new EventArgs());
        ...
        public static double GetWidthEx(DependencyObject obj) => (double)obj.GetValue(WidthExProperty);
        ...
        public static void SetWidthEx(DependencyObject obj, double value) => obj.SetValue(WidthExProperty, value);
        ...
        private static void OnWidthExChanged(DependencyObject obj, DependencyPropertyChangedEventArgs args)
        {
            ...
            if (element is Control control) element.Width += control.Padding.Left + control.Padding.Right;
        ...
        public static double GetMinWidthEx(DependencyObject obj) => (double)obj.GetValue(MinWidthExProperty);
        ...
        /// <param name="obj">Object to set the size on</param>
        /// <param name="value">Value to set</param>
        public static void SetMinWidthEx(DependencyObject obj, double value) => obj.SetValue(MinWidthExProperty, value);
        ...
        public static double GetMaxWidthEx(DependencyObject obj) => (double)obj.GetValue(MaxWidthExProperty);
        ...
        /// <param name="obj">Object to set the size on</param>
        /// <param name="value">Value to set</param>
        public static void SetMaxWidthEx(DependencyObject obj, double value) => obj.SetValue(MaxWidthExProperty, value);
        ...
        private static double GetAbstractWidth(DependencyObject element, double width)
        {
            ...
            if (face.TryGetGlyphTypeface(out var glyph))
            {
        ...
        public static double GetHeightEx(DependencyObject obj) => (double)obj.GetValue(HeightExProperty);
        ...
        /// <param name="obj">Object to set the size on</param>
        /// <param name="value">Value to set</param>
        public static void SetHeightEx(DependencyObject obj, double value) => obj.SetValue(HeightExProperty, value);
        ...
        private static void OnHeightExChanged(DependencyObject obj, DependencyPropertyChangedEventArgs args)
        {
            ...
            if (element is Control control) element.Height += control.Padding.Top + control.Padding.Bottom;
            InvalidateAllVisuals(element);
        }
        ...
        public static double GetMinHeightEx(DependencyObject obj) => (double)obj.GetValue(MinHeightExProperty);
        ...
        /// <param name="obj">Object to set the size on</param>
        /// <param name="value">Value to set</param>
        public static void SetMinHeightEx(DependencyObject obj, double value) => obj.SetValue(MinHeightExProperty, value);
        ...
        public static double GetMaxHeightEx(DependencyObject obj) => (double)obj.GetValue(MaxHeightExProperty);
        ...
        /// <param name="obj">Object to set the size on</param>
        /// <param name="value">Value to set</param>
        public static void SetMaxHeightEx(DependencyObject obj, double value) => obj.SetValue(MaxHeightExProperty, value);
        ...
        public static FontFamily GetLabelFontFamily(DependencyObject obj) => (FontFamily)obj.GetValue(LabelFontFamilyProperty);

        /// <summary>Font family for the abstract label</summary>
        /// <param name="obj">Dependency object</param>
        /// <param name="value">The value.</param>
        public static void SetLabelFontFamily(DependencyObject obj, FontFamily value) => obj.SetValue(LabelFontFamilyProperty, value);

        /// <summary>Font style for the abstract label</summary>
        /// <param name="obj">Dependency object</param>
        /// <returns>Font size</returns>
        public static FontStyle GetLabelFontStyle(DependencyObject obj) => (FontStyle)obj.GetValue(LabelFontStyleProperty);

        /// <summary>Font style for the abstract label</summary>
        /// <param name="obj">Dependency object</param>
        /// <param name="value">The value.</param>
        public static void SetLabelFontStyle(DependencyObject obj, FontStyle value) => obj.SetValue(LabelFontStyleProperty, value);

        /// <summary>Font weight for the abstract label</summary>
        /// <param name="obj">Dependency object</param>
        /// <returns>Font size</returns>
        public static FontWeight GetLabelFontWeight(DependencyObject obj) => (FontWeight)obj.GetValue(LabelFontWeightProperty);

        /// <summary>Font weight for the abstract label</summary>
        /// <param name="obj">Dependency object</param>
        /// <param name="value">The value.</param>
        public static void SetLabelFontWeight(DependencyObject obj, FontWeight value) => obj.SetValue(LabelFontWeightProperty, value);

        /// <summary>Font size for the abstract label</summary>
        /// <param name="obj">Dependency object</param>
        /// <returns>Font size</returns>
        public static double GetLabelFontSize(DependencyObject obj) => (double)obj.GetValue(LabelFontSizeProperty);

        /// <summary>Font size for the abstract label</summary>
        /// <param name="obj">Dependency object</param>
        /// <param name="value">The value.</param>
        public static void SetLabelFontSize(DependencyObject obj, double value) => obj.SetValue(LabelFontSizeProperty, value);

        /// <summary>Font color for the abstract label</summary>
        /// <param name="obj">Dependency object</param>
        /// <returns>Font size</returns>
        public static Brush GetLabelForegroundBrush(DependencyObject obj) => (Brush)obj.GetValue(LabelForegroundBrushProperty);

        /// <summary>Font color for the abstract label</summary>
        /// <param name="obj">Dependency object</param>
        /// <param name="value">The value.</param>
        public static void SetLabelForegroundBrush(DependencyObject obj, Brush value) => obj.SetValue(LabelForegroundBrushProperty, value);
        ...
        public static string GetIconResourceKey(DependencyObject obj) => (string)obj.GetValue(IconResourceKeyProperty);

        /// <summary>View icon resource key</summary>
        /// <param name="obj">Object to set the icon resource key on</param>
        /// <param name="value">Value to set</param>
        public static void SetIconResourceKey(DependencyObject obj, string value) => obj.SetValue(IconResourceKeyProperty, value);

        /// <summary>
        ///     Theme color used by the view (utilized by some themes to create color schemes)
        /// </summary>
        public static void SetViewThemeColor(DependencyObject d, Color value) => d.SetValue(ViewThemeColorProperty, value);

        /// <summary>
        ///     Theme color used by the view (utilized by some themes to create color schemes)
        /// </summary>
        public static Color GetViewThemeColor(DependencyObject d) => (Color)d.GetValue(ViewThemeColorProperty);
        ...
        public static Brush GetTitleColor(DependencyObject obj) => (Brush)obj.GetValue(TitleColorProperty);
        ...
        /// <param name="obj">The object to get the color for.</param>
        /// <returns>Title color (brush)</returns>
        public static Brush GetTitleColor2(DependencyObject obj) => (Brush)obj.GetValue(TitleColor2Property);
        ...
        /// <remarks>This attached property can be attached to any UI Element to define a view group</remarks>
        public static string GetGroup(DependencyObject obj) => (string)obj.GetValue(GroupProperty);

        /// <summary>View group</summary>
        /// <param name="obj">Object to set the group on</param>
        /// <param name="value">Value to set</param>
        public static void SetGroup(DependencyObject obj, string value) => obj.SetValue(GroupProperty, value);
        ...
        public static ViewSizeStrategies GetSizeStrategy(DependencyObject obj) => (ViewSizeStrategies)obj.GetValue(SizeStrategyProperty);

        /// <summary>View size strategy</summary>
        /// <param name="obj">Object to set the size strategy on</param>
        /// <param name="value">Value to set</param>
        public static void SetSizeStrategy(DependencyObject obj, ViewSizeStrategies value) => obj.SetValue(SizeStrategyProperty, value);
        ...
        ///     Otherwise, the view is handled as if the strategy is set to use maximum size.
        /// </remarks>
        public static double GetSuggestedHeight(DependencyObject obj) => (double)obj.GetValue(SuggestedHeightProperty);
        ...
        ///     Otherwise, the view is handled as if the strategy is set to use maximum size.
        /// </remarks>
        public static void SetSuggestedHeight(DependencyObject obj, double value) => obj.SetValue(SuggestedHeightProperty, value);
        ...
        ///     Otherwise, the view is handled as if the strategy is set to use maximum size.
        /// </remarks>
        public static double GetSuggestedWidth(DependencyObject obj) => (double)obj.GetValue(SuggestedWidthProperty);
        ...
        ///     Otherwise, the view is handled as if the strategy is set to use maximum size.
        /// </remarks>
        public static void SetSuggestedWidth(DependencyObject obj, double value) => obj.SetValue(SuggestedWidthProperty, value);

        /// <summary>Column break indicator</summary>
        /// <param name="obj">Object to set the value on</param>
        /// <returns>Value</returns>
        public static bool GetColumnBreak(DependencyObject obj) => (bool)obj.GetValue(ColumnBreakProperty);

        /// <summary>Column break indicator</summary>
        /// <param name="obj">Object to get the value for</param>
        /// <param name="value">Value</param>
        public static void SetColumnBreak(DependencyObject obj, bool value) => obj.SetValue(ColumnBreakProperty, value);

        /// <summary>Group break indicator</summary>
        /// <param name="obj">Object to set the value on</param>
        /// <returns>Value</returns>
        public static bool GetGroupBreak(DependencyObject obj) => (bool)obj.GetValue(GroupBreakProperty);

        /// <summary>Group break indicator</summary>
        /// <param name="obj">Object to get the value for</param>
        /// <param name="value">Value</param>
        public static void SetGroupBreak(DependencyObject obj, bool value) => obj.SetValue(GroupBreakProperty, value);

        /// <summary>Group caption/title</summary>
        public static string GetGroupTitle(DependencyObject obj) => (string)obj.GetValue(GroupTitleProperty);

        /// <summary>Group caption/title</summary>
        public static void SetGroupTitle(DependencyObject obj, string value) => obj.SetValue(GroupTitleProperty, value);

        /// <summary>
        ///     Property used to determine whether the control is to be seen as a standard flow element, or whether it is to
        ///     be put together with the previous element
        /// </summary>
        public static bool GetFlowsWithPrevious(DependencyObject obj) => (bool)obj.GetValue(FlowsWithPreviousProperty);

        /// <summary>
        ///     Property used to determine whether the control is to be seen as a standard flow element, or whether it is to
        ///     be put together with the previous element
        /// </summary>
        public static void SetFlowsWithPrevious(DependencyObject obj, bool value) => obj.SetValue(FlowsWithPreviousProperty, value);

        /// <summary>Property used to determine whether a line break shall be forced before the control</summary>
        public static bool GetLineBreak(DependencyObject obj) => (bool)obj.GetValue(LineBreakProperty);

        /// <summary>Property used to determine whether a line break shall be forced before the control</summary>
        public static void SetLineBreak(DependencyObject obj, bool value) => obj.SetValue(LineBreakProperty, value);

        /// <summary>Property used to determine whether the control shall span the complete available width</summary>
        public static bool GetSpanFullWidth(DependencyObject obj) => (bool)obj.GetValue(SpanFullWidthProperty);

        /// <summary>Property used to determine whether the control shall span the complete available width</summary>
        public static void SetSpanFullWidth(DependencyObject obj, bool value) => obj.SetValue(SpanFullWidthProperty, value);

        /// <summary>Group break indicator</summary>
        /// <param name="obj">Object to set the value on</param>
        /// <returns>Value</returns>
        public static UIElementTypes GetUIElementType(DependencyObject obj) => (UIElementTypes)obj.GetValue(UIElementTypeProperty);

        /// <summary>Group break indicator</summary>
        /// <param name="obj">Object to get the value for</param>
        /// <param name="value">Value</param>
        public static void SetUIElementType(DependencyObject obj, UIElementTypes value) => obj.SetValue(UIElementTypeProperty, value);

        /// <summary>Defines the title of the UI element</summary>
        /// <param name="obj">Object to set the value on</param>
        /// <returns>Value</returns>
        public static string GetUIElementTitle(DependencyObject obj) => (string)obj.GetValue(UIElementTitleProperty);

        /// <summary>Defines the title of the UI element</summary>
        /// <param name="obj">Object to get the value for</param>
        /// <param name="value">Value</param>
        public static void SetUIElementTitle(DependencyObject obj, string value) => obj.SetValue(UIElementTitleProperty, value);

        /// <summary>Stand alone label indicator</summary>
        /// <param name="obj">Object to set the value on</param>
        /// <returns>Value</returns>
        public static bool GetIsStandAloneLabel(DependencyObject obj) => (bool)obj.GetValue(IsStandAloneLabelProperty);

        /// <summary>Stand alone label indicator</summary>
        /// <param name="obj">Object to get the value for</param>
        /// <param name="value">Value</param>
        public static void SetIsStandAloneLabel(DependencyObject obj, bool value) => obj.SetValue(IsStandAloneLabelProperty, value);

        /// <summary>Stand alone edit control indicator</summary>
        /// <param name="obj">Object to set the value on</param>
        /// <returns>Value</returns>
        public static bool GetIsStandAloneEditControl(DependencyObject obj) => (bool)obj.GetValue(IsStandAloneEditControlProperty);

        /// <summary>Stand alone edit control indicator</summary>
        /// <param name="obj">Object to get the value for</param>
        /// <param name="value">Value</param>
        public static void SetIsStandAloneEditControl(DependencyObject obj, bool value) => obj.SetValue(IsStandAloneEditControlProperty, value);
        ...
        private static void OnBehaviorChanged(DependencyObject obj, DependencyPropertyChangedEventArgs args)
        {
            ...
            if (oldValue != newValue)
            {
                ...
                foreach (var behaviorType in behaviorTypes)
                {
                    ...
                    if (instance != null && instance is Behavior.Behavior behavior)
                        behavior.Attach(obj);
                }
            }
        }
        ...
        public static void SetBehavior(UIElement element, string value) => element.SetValue(BehaviorProperty, value);
        ...
        public static string GetBehavior(UIElement element) => (string)element.GetValue(BehaviorProperty);
        ...
        public static UIElement GetFocusForwardingTarget(DependencyObject obj) => (UIElement)obj.GetValue(FocusForwardingTargetProperty);

        /// <summary>Focus forwarding setter</summary>
        /// <param name="obj">The object the property is set on.</param>
        /// <param name="value">UIElement or null</param>
        public static void SetFocusForwardingTarget(DependencyObject obj, UIElement value) => obj.SetValue(FocusForwardingTargetProperty, value);

        /// <summary>Focus forwarding is enabled getter</summary>
        /// <param name="obj">The object the property is set on.</param>
        /// <returns>UIElement or null</returns>
        public static bool GetFocusForwardingIsEnabled(DependencyObject obj) => (bool)obj.GetValue(FocusForwardingIsEnabledProperty);

        /// <summary>Focus forwarding is enabled setter</summary>
        /// <param name="obj">The object the property is set on.</param>
        /// <param name="value">UIElement or null</param>
        public static void SetFocusForwardingIsEnabled(DependencyObject obj, bool value) => obj.SetValue(FocusForwardingIsEnabledProperty, value);
        ...
        public static bool GetDocked(DependencyObject obj) => (bool)obj.GetValue(DockedProperty);

        /// <summary>Indicates whether a view element is "docked" into the main object or not.</summary>
        /// <param name="obj">The object the property is set on.</param>
        /// <param name="value">True or false</param>
        public static void SetDocked(DependencyObject obj, bool value) => obj.SetValue(DockedProperty, value);

        /// <summary>Indicates whether an element can be docked and undocked</summary>
        /// <param name="obj">The object the property is set on.</param>
        /// <returns>True or false</returns>
        public static bool GetSupportsDocking(DependencyObject obj) => (bool)obj.GetValue(SupportsDockingProperty);

        /// <summary>Indicates whether an element can be docked and undocked</summary>
        /// <param name="obj">The object the property is set on.</param>
        /// <param name="value">True or false</param>
        public static void SetSupportsDocking(DependencyObject obj, bool value) => obj.SetValue(SupportsDockingProperty, value);

        /// <summary>Indicates whether an element can be independenty closed</summary>
        /// <param name="obj">The object the property is set on.</param>
        /// <returns>True or false</returns>
        public static bool GetClosable(DependencyObject obj) => (bool)obj.GetValue(ClosableProperty);

        /// <summary>Indicates whether an element can be independenty closed</summary>
        /// <param name="obj">The object the property is set on.</param>
        /// <param name="value">True or false</param>
        public static void SetClosable(DependencyObject obj, bool value) => obj.SetValue(ClosableProperty, value);
        ...
        ///     simply set to collapsed.
        /// </remarks>
        public static ICommand GetCloseAction(DependencyObject obj) => (ICommand)obj.GetValue(CloseActionProperty);
        ...
        ///     simply set to collapsed.
        /// </remarks>
        public static void SetCloseAction(DependencyObject obj, ICommand value) => obj.SetValue(CloseActionProperty, value);
        ...
        private static void OnRelativeWidthChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (element.Parent != null && element.Parent is UIElement parentElement)
            {
        ...
        /// <param name="obj">The object the property is set on.</param>
        /// <returns>True or false</returns>
        public static GridLength GetRelativeWidth(DependencyObject obj) => (GridLength)obj.GetValue(RelativeWidthProperty);

        /// <summary>Indicates the relative width of an alement compared to other elements</summary>
        /// <param name="obj">The object the property is set on.</param>
        /// <param name="value">True or false</param>
        public static void SetRelativeWidth(DependencyObject obj, GridLength value) => obj.SetValue(RelativeWidthProperty, value);
        ...
        /// <param name="obj">The object the property is set on.</param>
        /// <returns>True or false</returns>
        public static GridLength GetRelativeHeight(DependencyObject obj) => (GridLength)obj.GetValue(RelativeHeightProperty);

        /// <summary>Indicates the relative height of an alement compared to other elements</summary>
        /// <param name="obj">The object the property is set on.</param>
        /// <param name="value">True or false</param>
        public static void SetRelativeHeight(DependencyObject obj, GridLength value) => obj.SetValue(RelativeHeightProperty, value);
        ...
        {
            if (!(source is UIElement element)) return;

            element.InvalidateArrange();
            element.InvalidateMeasure();
            element.InvalidateVisual();

            if (!(element is FrameworkElement element2) || element2.Parent == null) return;
            if (!(element2.Parent is FrameworkElement element3)) return;
