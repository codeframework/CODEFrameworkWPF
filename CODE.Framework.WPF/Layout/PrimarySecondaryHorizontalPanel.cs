...
namespace CODE.Framework.Wpf.Layout
{
    ...
    public class PrimarySecondaryHorizontalPanel : Panel
    {
        ...
        {
            get => (bool)GetValue(CanCollapseSecondaryProperty);
        ...
        {
            get => (bool)GetValue(IsSecondaryElementCollapsedProperty);
        ...
        {
            if (d is not PrimarySecondaryHorizontalPanel panel) return;
        ...
        {
            get => (double)GetValue(SecondaryElementWidthProperty); 
        ...
        {
            get => (IPrimarySecondaryHorizontalPanelHeaderRenderer)GetValue(HeaderRendererProperty);
        ...
        {
            get => (SecondaryAreaLocation)GetValue(SecondaryAreaLocationProperty); 
        ...
        {
            get => (Brush)GetValue(PrimaryAreaBackgroundProperty); 
        ...
        {
            get => (Brush)GetValue(SecondaryAreaBackgroundProperty); 
    ...
    public class StandardPrimarySecondaryHorizontalPanelHeaderRenderer : FrameworkElement, IPrimarySecondaryHorizontalPanelHeaderRenderer
    {
        ...
        {
            get => (Brush)GetValue(CollapsedSecondaryAreaIconProperty); 
        ...
        {
            get => (Brush)GetValue(ExpandedSecondaryAreaIconProperty); 
        ...
        {
            get => (Size)GetValue(ExpandCollapseIconSizeProperty); 
        ...
        {
            get => (bool)GetValue(IgnoreIconSizeForLayoutProperty); 
        ...
        /// <param name="parentPanel">The parent panel.</param>
        /// <returns>The client size (area usable by the contained element, which excludes areas needed for header information)</returns>
        public Rect GetPrimaryClientArea(Rect totalPrimaryArea, PrimarySecondaryHorizontalPanel parentPanel) => totalPrimaryArea;
        ...
        /// <param name="parentPanel">The parent panel.</param>
        /// <returns>Minimum width of the area</returns>
        public double GetMinimumCollapsedAreaWidth(PrimarySecondaryHorizontalPanel parentPanel) => ExpandCollapseIconSize.Width;
