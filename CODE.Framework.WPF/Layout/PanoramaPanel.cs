...
namespace CODE.Framework.Wpf.Layout
{
    ...
    public class PanoramaPanel : Panel
    {
        ...
        {
            if (d is not PanoramaPanel panorama) return;
        ...
        {
            get => (Brush)GetValue(SelectedHeaderForegroundProperty);
        ...
        {
            get => (Brush)GetValue(UnselectedHeaderForegroundProperty);
        ...
        {
            get => (double)GetValue(HorizontalHeaderRenderingOffsetProperty);
