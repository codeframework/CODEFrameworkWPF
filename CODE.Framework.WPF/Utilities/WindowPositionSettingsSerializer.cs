...
//            try
//            {
//                if (!(stateObject is Window window)) return string.Empty;
...
//            try
//            {
//                if (!(stateObject is Window window)) return;
//                if (string.IsNullOrEmpty(state)) return;

//                // Since we are manually setting the window position we prevent automatically set startup positions to interfere with our settings here
...
//        public virtual bool CanHandle(object stateObject, string id, SettingScope scope) => stateObject is Window;
...
//        public virtual string GetSuggestedFileName(object stateObject, string id, SettingScope scope) => id + ".WindowPosition.json";
...
//        public virtual bool UseInAdditionToOtherAppliedSerializers => true;
//    }
//}
