// TODO: Implement this without a dependency on Json.net
...
//        /// Static constructor
//        /// </summary>
//        static SettingsManager() => LastSaveSettingsError = string.Empty;
...
//            MostRecentlyUsedChanged?.Invoke(null, new MostRecentlyUsedEventArgs { Area = area, Scope = scope, LastItemAdded = mruItem, CompleteList = existingList });
...
//        {
//            if (string.IsNullOrEmpty(id) && ResolveSettingId != null)
//                id = ResolveSettingId(id, stateObject);
...
//        /// <summary>
//        /// This delegate can be used to override setting IDs beyond the default resolution based on the full type name
//        /// </summary>
//        public static Func<string, object, string> ResolveSettingId { get; set; }
...
//        /// </summary>
//        public static void ResetSerializers() => RegisteredSerializers.Clear();
...
//        public static bool HasRegisteredSerializer<T>() => RegisteredSerializers.Any(s => s.GetType() == typeof(T));
//    }
...
//        /// <param name="stateObject">Object to serialize</param>
//        /// <returns>State JSON</returns>
//        public virtual string SerializeToJson(object stateObject) => JsonHelper.SerializeToRestJson(stateObject);
...
//        /// <param name="stateObject">Object to set the persisted state on.</param>
//        /// <param name="state">State information (JSON)</param>
//        public virtual void DeserializeFromJson(object stateObject, string state) => JsonConvert.PopulateObject(state, stateObject);
...
//        /// <param name="scope">Scope of the setting</param>
//        /// <returns>True if the serializer can handle the provided object</returns>
//        public virtual bool CanHandle(object stateObject, string id, SettingScope scope) => true; // We at least attempt to handle everything that comes our way
...
//        /// <param name="scope">Scope of the setting</param>
//        /// <returns>File name, or string.Empty if no default is suggested</returns>
//        public virtual string GetSuggestedFileName(object stateObject, string id, SettingScope scope) => string.Empty;
...
//        /// </summary>
//        /// <value>True or False</value>
//        public virtual bool UseInAdditionToOtherAppliedSerializers => false;
//    }
...
//                {
//                    if (Guid.TryParse(v, out var value))
//                        property.SetValue(stateObject, value, null);
//                }
//                else if (property.PropertyType == typeof(Guid?))
//                {
...
//                {
//                    if (DateTimeUtils.TryParseDateTimeIso(new StringReference(v.ToCharArray(), 0, v.Length), DateTimeZoneHandling.Unspecified, out var value))
//                        property.SetValue(stateObject, value, null);
//                }
//                else
...
//        /// <param name="scope">Scope of the setting</param>
//        /// <returns>File name, or string.Empty if no default is suggested</returns>
//        public virtual string GetSuggestedFileName(object stateObject, string id, SettingScope scope) => id + "." + typeof(T).Name + ".json";
...
//        /// <param name="scope">Scope of the setting</param>
//        /// <returns>True if the serializer can handle the provided object</returns>
//        public override bool CanHandle(object stateObject, string id, SettingScope scope) => stateObject != null && scope == SettingScope.Workstation;
//    }
...
//        /// <param name="scope">Scope of the setting</param>
//        /// <returns>True if the serializer can handle the provided object</returns>
//        public override bool CanHandle(object stateObject, string id, SettingScope scope) => stateObject != null && scope == SettingScope.User;
//    }
...
//        /// <param name="scope">Scope of the setting</param>
//        /// <returns>True if the serializer can handle the provided object</returns>
//        public override bool CanHandle(object stateObject, string id, SettingScope scope) => stateObject != null && scope == SettingScope.WorkstationAndUser;
//    }
...
//        /// </summary>
//        static MostRecentlyUsedListSerializer() => MaxItemCount = 20;
...
//        public void DeserializeFromJson(object stateObject, string state)
//        {
//            if (!(stateObject is List<MostRecentlyUsed> list)) return;
...
//        /// <param name="scope">Scope of the setting</param>
//        /// <returns>True if the serializer can handle the provided object</returns>
//        public bool CanHandle(object stateObject, string id, SettingScope scope) => stateObject is List<MostRecentlyUsed>;
...
//        /// <param name="scope">Scope of the setting</param>
//        /// <returns>File name, or string.Empty if no default is suggested</returns>
//        public string GetSuggestedFileName(object stateObject, string id, SettingScope scope) => $"{id}.mru.json";
