...
namespace CODE.Framework.Wpf.Utilities
{
    ...
    public static class SystemMetricsHelper
    {
        ...
        public static int NumberOfMouseButtons => GetMetric(SystemMetrics.SM_CMOUSEBUTTONS);

        /// <summary>Specifies how the system is started</summary>
        public static BootModes BootMode => (BootModes)GetMetric(SystemMetrics.SM_CLEANBOOT);

        /// <summary>The number of display monitors on a desktop.</summary>
        public static int NumberOfDisplayMonitors => GetMetric(SystemMetrics.SM_CMONITORS);

        /// <summary>
        /// Reflects the state of the laptop or slate mode, true for Slate Mode and false otherwise. 
        ...
        /// </summary>
        public static bool ConvertibleIsInSlateMode => GetMetric(SystemMetrics.SM_CMONITORS) < 1;
    }
