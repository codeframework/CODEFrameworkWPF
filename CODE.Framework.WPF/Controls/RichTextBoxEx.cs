...
namespace CODE.Framework.Wpf.Controls
{
    ...
    public class RichTextBoxEx : RichTextBox
    {
        ...
        public static string GetXaml(DependencyObject obj) => (string)obj.GetValue(XamlProperty);
        ...
        /// <param name="obj">The textbox object</param>
        /// <returns>XAML flow document string</returns>
        public static XamlEditMode GetXamlEditMode(DependencyObject obj) => (XamlEditMode)obj.GetValue(XamlEditModeProperty);
        ...
        /// <param name="obj">The textbox object</param>
        /// <param name="value">The XAML document string to set</param>
        public static void SetXamlEditMode(DependencyObject obj, XamlEditMode value) => obj.SetValue(XamlEditModeProperty, value);
        ...
        public static IFlowDocumentSerializer GetDocumentSerializer(DependencyObject obj) => (IFlowDocumentSerializer)obj.GetValue(DocumentSerializerProperty);
        ...
        public static void SetDocumentSerializer(DependencyObject obj, IFlowDocumentSerializer value) => obj.SetValue(DocumentSerializerProperty, value);
    }
