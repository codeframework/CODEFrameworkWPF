...
namespace CODE.Framework.Wpf.Controls
{
    ...
    public class BorderEx : Border
    {
        ...
        public static void SetKeepHeightAndWidthEqual(DependencyObject d, bool value) => d.SetValue(KeepHeightAndWidthEqualProperty, value);
        ...
        public static bool GetKeepHeightAndWidthEqual(DependencyObject d) => (bool)d.GetValue(KeepHeightAndWidthEqualProperty);
        ...
        public static bool GetForceCircularOutline(DependencyObject obj) => (bool)obj.GetValue(ForceCircularOutlineProperty);
        ...
        public static void SetForceCircularOutline(DependencyObject obj, bool value) => obj.SetValue(ForceCircularOutlineProperty, value);
