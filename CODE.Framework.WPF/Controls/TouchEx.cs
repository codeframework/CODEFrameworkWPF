...
namespace CODE.Framework.Wpf.Controls
{
    ...
    public class TouchEx : DependencyObject
    {
        ...
        /// If set to true, the PointingDeviceInputMode attached property is automatically and continuously set on the target object
        /// </summary>
        public static bool GetUpdatePointingDeviceInputMode(DependencyObject d) => (bool)d.GetValue(UpdatePointingDeviceInputModeProperty);
        /// <summary>
        /// If set to true, the PointingDeviceInputMode attached property is automatically and continuously set on the target object
        /// </summary>
        public static void SetUpdatePointingDeviceInputMode(DependencyObject d, bool value) => d.SetValue(UpdatePointingDeviceInputModeProperty, value);
        ...
        /// <param name="e">Event args</param>
        private static void OnPointingDeviceInputModeChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) => _mostRecentPointingDeviceInputMode = (PointingDeviceInputMode)e.NewValue;

        /// <summary>
        /// Indicates the current input mode
        /// </summary>
        /// <remarks>This property should never be set manually. It is auto-updated if UpdatePointingDeviceInputMode is set to true.</remarks>
        public static PointingDeviceInputMode GetPointingDeviceInputMode(DependencyObject d) => (PointingDeviceInputMode)d.GetValue(PointingDeviceInputModeProperty);

        /// <summary>
        /// Indicates the current input mode
        /// </summary>
        /// <remarks>This property should never be set manually. It is auto-updated if UpdatePointingDeviceInputMode is set to true.</remarks>
        public static void SetPointingDeviceInputMode(DependencyObject d, PointingDeviceInputMode value) => d.SetValue(PointingDeviceInputModeProperty, value);
    }
