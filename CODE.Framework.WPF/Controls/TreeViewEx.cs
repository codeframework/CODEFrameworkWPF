...
namespace CODE.Framework.Wpf.Controls
{
    ...
    public class TreeViewEx : TreeView
    {
        ...
        {
            if (d is not TreeViewEx tree) return;
        ...
        public void SelectItem(object item)
        {
            ...
            if (container is not TreeViewItem treeItem) return;
        ...
        {
            get => (bool)GetValue(BringItemIntoViewWhenSelectedProperty);
            set => SetValue(BringItemIntoViewWhenSelectedProperty, value);
        }

        ///<summary>When set to true, programmatically selecting an item in the tree will also bring it into view</summary>
        public static readonly DependencyProperty BringItemIntoViewWhenSelectedProperty = DependencyProperty.Register("BringItemIntoViewWhenSelected", typeof(bool), typeof(TreeViewEx));
