...
namespace CODE.Framework.Wpf.Controls
{
    ...
    public class TextBoxEx : TextBox
    {
        ...
        public static void SetWatermarkText(DependencyObject o, string value) => o.SetValue(WatermarkTextProperty, value);

        /// <summary>Watermark text property (can be used to set text for empty textboxes)</summary>
        /// <param name="o">The object to get the value for.</param>
        /// <returns>System.String.</returns>
        public static string GetWatermarkText(DependencyObject o) => (string)o.GetValue(WatermarkTextProperty);
        ...
        /// Sets the input mask.
        /// </summary>
        public static void SetInputMaskRegEx(DependencyObject o, string value) => o.SetValue(InputMaskRegExProperty, value);

        /// <summary>
        /// Gets the input mask.
        /// </summary>
        public static string GetInputMaskRegEx(DependencyObject o) => (string)o.GetValue(InputMaskRegExProperty);
        ...
        public static bool GetUseCustomDictionaries(DependencyObject obj) => (bool)obj.GetValue(UseCustomDictionariesProperty);
        ...
        private static void addToDictionary_Click(object sender, RoutedEventArgs e) => WriteToDictionary(sender, _customDictionaryFile);

        private static void ignoreAll_Click(object sender, RoutedEventArgs e) => WriteToDictionary(sender, _ignoreAllDictionaryFile);
        ...
        /// </summary>
        /// <param name="d">The object the property is set on</param>
        public static bool GetUpdateSourceOnEnterKey(DependencyObject d) => (bool)d.GetValue(UpdateSourceOnEnterKeyProperty);
        ...
        public static void SetUpdateSourceOnEnterKey(DependencyObject d, bool value) => d.SetValue(UpdateSourceOnEnterKeyProperty, value);
        ...
        public static string GetTextUnmasked(DependencyObject d) => (string)d.GetValue(TextUnmaskedProperty);
        ...
        public static void SetTextUnmasked(DependencyObject d, string value) => d.SetValue(TextUnmaskedProperty, value);
        ...
        public static string GetInputMaskDecimalCharacteristicMask(DependencyObject d) => d.GetValue(InputMaskDecimalCharacteristicMaskProperty).ToString();
        ...
        public static void SetInputMaskDecimalCharacteristicMask(DependencyObject d, string value) => d.SetValue(InputMaskDecimalCharacteristicMaskProperty, value);
        ...
        public static string GetInputMaskDecimalFractionalMask(DependencyObject d) => d.GetValue(InputMaskDecimalFractionalMaskProperty).ToString();
        ...
        public static void SetInputMaskDecimalFractionalMask(DependencyObject d, string value) => d.SetValue(InputMaskDecimalFractionalMaskProperty, value);
        ...
        public static string GetInputMaskCurrencySymbol(DependencyObject d) => (string)d.GetValue(InputMaskCurrencySymbolProperty);
        ...
        public static void SetInputMaskCurrencySymbol(DependencyObject d, string value) => d.SetValue(InputMaskCurrencySymbolProperty, value);
        ...
        public static bool GetInputMaskSupportsNegative(DependencyObject d) => (bool)d.GetValue(InputMaskSupportsNegativeProperty);
        ...
        public static void SetInputMaskSupportsNegative(DependencyObject d, bool value) => d.SetValue(InputMaskSupportsNegativeProperty, value);
        ...
        private static void HandleInputMaskDecimalKeyDown(Key key, TextBox textbox, string mask)
        {
            ...
            if (allChars.Count > currencySymbol.Length && allChars[currencySymbol.Length] == '-')
            {
                valueIsNegative = true;
                valueWasNegativeOnEnter = true;
            }
            if (!valueWasNegativeOnEnter && allChars.Count > currencySymbol.Length + 1 && allChars[currencySymbol.Length + 1] == '-')
            {
                valueIsNegative = true;
                valueWasNegativeOnEnter = true;
            }
            ...
            if (decimal.TryParse(newText, out parsedValue))
            {
                ...
                if (valueIsNegative && parsedValue == 0m && !newText.StartsWith("-"))
                    newText = "-" + newText; // When the value is 0 and the user already indicated a negative value, the above code will remove the minus symbol, as 0 really has no negative version

                if (isCurrency) newText = currencySymbol + " " + newText;
                if (isDecimal) newText += "%";
                ...
                if (newChar == '-') // If the minus character was entered, we always position the caret to the right of it
                    textbox.CaretIndex = newText.IndexOf('-') + 1;
                else if (newChar == '+') // If the plus character was entered, we always position the caret at the start of the numeric text
                    textbox.CaretIndex = currencySymbol.Length + 1;
                else
                {
                    var newCaretIndex = 0;
                    var digitsFound = 0;
                    ...
                    foreach (var newAllChar in newAllChars)
                    {
                        ...
                        if (isCurrency)
                        {
                            if (newCaretIndex > currencySymbol.Length && (char.IsDigit(newAllChar) || (valueIsNegative && newAllChar == '-'))) digitsFound++;
                        }
