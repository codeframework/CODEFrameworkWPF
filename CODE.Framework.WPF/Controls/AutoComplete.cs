...
namespace CODE.Framework.Wpf.Controls
{
    ...
    public class AutoComplete : ListBox
    {
        ...
        public static IEnumerable GetAutoCompleteItemsSource(DependencyObject obj) => (IEnumerable)obj.GetValue(AutoCompleteItemsSourceProperty);

        /// <summary>Auto complete items source</summary>
        /// <param name="obj">Object to set the auto complete items source on</param>
        /// <param name="value">Value to set</param>
        public static void SetAutoCompleteItemsSource(DependencyObject obj, IEnumerable value) => obj.SetValue(AutoCompleteItemsSourceProperty, value);
        ...
        public static object GetAutoCompleteSelectedItem(DependencyObject obj) => obj.GetValue(AutoCompleteSelectedItemProperty);

        /// <summary>Auto complete selected item</summary>
        /// <param name="obj">Object to set the auto complete selected item on</param>
        /// <param name="value">Value to set</param>
        public static void SetAutoCompleteSelectedItem(DependencyObject obj, object value) => obj.SetValue(AutoCompleteSelectedItemProperty, value);
        ...
        protected override void OnItemsSourceChanged(IEnumerable oldValue, IEnumerable newValue)
        {
            ...
            if (newValue is not INotifyCollectionChanged observable) return;
        ...
        /// <param name="obj">Object to set the auto complete items source on</param>
        /// <returns>Auto complete items source</returns>
        public static string GetAutoCompleteDisplayMemberPathSource(DependencyObject obj) => (string)obj.GetValue(AutoCompleteDisplayMemberPathProperty);

        /// <summary>Auto complete items source</summary>
        /// <param name="obj">Object to set the auto complete items source on</param>
        /// <param name="value">Value to set</param>
        public static void SetAutoCompleteDisplayMemberPath(DependencyObject obj, string value) => obj.SetValue(AutoCompleteDisplayMemberPathProperty, value);
        ...
        public static AutoComplete GetAutoCompleteUI(DependencyObject obj) => (AutoComplete)obj.GetValue(AutoCompleteUIProperty);
        ...
        public static DataTemplate GetAutoCompleteItemTemplate(DependencyObject obj) => (DataTemplate)obj.GetValue(AutoCompleteItemTemplateProperty);

        /// <summary>Auto complete item template</summary>
        /// <param name="obj">Object to set the auto complete item template on</param>
        /// <param name="value">Value to set</param>
        public static void SetAutoCompleteItemTemplate(DependencyObject obj, DataTemplate value) => obj.SetValue(AutoCompleteItemTemplateProperty, value);
        ...
        public static Style GetAutoCompleteStyle(DependencyObject obj) => (Style)obj.GetValue(AutoCompleteStyleProperty);

        /// <summary>Auto complete style</summary>
        /// <param name="obj">Object to set the auto complete style on</param>
        /// <param name="value">Value to set</param>
        public static void SetAutoCompleteStyle(DependencyObject obj, Style value) => obj.SetValue(AutoCompleteStyleProperty, value);
    ...
    public class AutoCompleteDropDownAdorner : Adorner
    {
        ...
        /// </returns>
        protected override Visual GetVisualChild(int index) => _ui;
    }
}
