...
namespace CODE.Framework.Wpf.Controls
{
    ...
    public class SortOrderIndicator : ContentControl
    {
        ...
        {
            if (Content is not Rectangle rect) return;
            ...
            if (Parent is not UIElement element) return;
        ...
        {
            get => (SortOrder)GetValue(OrderProperty);
        ...
        {
            if (d is not SortOrderIndicator control) return;
            control.SetBrush();
        }
        ...
        {
            get => (Brush)GetValue(UnsortedBrushProperty);
        ...
        {
            get => (Brush)GetValue(AscendingBrushProperty);
        ...
        {
            get => (Brush)GetValue(DescendingBrushProperty);
