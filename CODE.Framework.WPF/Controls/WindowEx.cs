...
namespace CODE.Framework.Wpf.Controls
{
    ...
    public class WindowEx : Window
    {
        ...
        /// Creates a stylable version of the window startup position (the default property on the Window class is not a dependency property)
        /// </summary>
        public static WindowStartupLocation GetWindowStartupLocationStylable(DependencyObject obj) => (WindowStartupLocation)obj.GetValue(WindowStartupLocationStylableProperty);

        /// <summary>
        /// Creates a stylable version of the window startup position (the default property on the Window class is not a dependency property)
        /// </summary>
        public static void SetWindowStartupLocationStylable(DependencyObject obj, WindowStartupLocation value) => obj.SetValue(WindowStartupLocationStylableProperty, value);
        ...
        /// If set to true, the Window will remember the last size and position it had and re-open at that same position
        /// </summary>
        public static bool GetAutoSaveWindowPosition(DependencyObject obj) => (bool)obj.GetValue(AutoSaveWindowPositionProperty);

        /// <summary>
        /// If set to true, the Window will remember the last size and position it had and re-open at that same position
        /// </summary>
        public static void SetAutoSaveWindowPosition(DependencyObject obj, bool value) => obj.SetValue(AutoSaveWindowPositionProperty, value);
        ...
        /// <summary>If set to true, the window can be dragged automatically by clicking in the background or header area</summary>
        public static bool GetAutoWindowDragEnabled(DependencyObject obj) => (bool)obj.GetValue(AutoWindowDragEnabledProperty);

        /// <summary>If set to true, the window can be dragged automatically by clicking in the background or header area</summary>
        public static void SetAutoWindowDragEnabled(DependencyObject obj, bool value) => obj.SetValue(AutoWindowDragEnabledProperty, value);
        ...
        {
            if (dependencyObject is Window win)
            {
        ...
        /// <summary>For internal use only</summary>
        [Browsable(false)]
        public static Point GetCurrentDragOperationStartScreenPosition(DependencyObject obj) => (Point)obj.GetValue(CurrentDragOperationStartScreenPositionProperty);

        /// <summary>For internal use only</summary>
        [Browsable(false)]
        public static void SetCurrentDragOperationStartScreenPosition(DependencyObject obj, Point value) => obj.SetValue(CurrentDragOperationStartScreenPositionProperty, value);
        ...
        /// <summary>For internal use only</summary>
        [Browsable(false)]
        public static Point GetCurrentDragOperationStartWindowPosition(DependencyObject obj) => (Point)obj.GetValue(CurrentDragOperationStartWindowPositionProperty);

        /// <summary>For internal use only</summary>
        [Browsable(false)]
        public static void SetCurrentDragOperationStartWindowPosition(DependencyObject obj, Point value) => obj.SetValue(CurrentDragOperationStartWindowPositionProperty, value);
        ...
        /// <summary>If set to true, the window can be dragged automatically by clicking in the background or header area</summary>
        public static bool GetAutoWindowMaximizeEnabled(DependencyObject obj) => (bool)obj.GetValue(AutoWindowMaximizeEnabledProperty);

        /// <summary>If set to true, the window can be dragged automatically by clicking in the background or header area</summary>
        public static void SetAutoWindowMaximizeEnabled(DependencyObject obj, bool value) => obj.SetValue(AutoWindowMaximizeEnabledProperty, value);
        ...
        /// <summary>Window icon path (set dynamically, which means it doesn't have to exist during design time)</summary>
        public static string GetDynamicIcon(DependencyObject obj) => (string)obj.GetValue(DynamicIconProperty);

        /// <summary>Window icon path (set dynamically, which means it doesn't have to exist during design time)</summary>
        public static void SetDynamicIcon(DependencyObject obj, string value) => obj.SetValue(DynamicIconProperty, value);
        ...
        /// <summary>
        /// Defines whether CODE Framework's custom min/max handling kicks in (default) or not.
        /// </summary>
        /// <remarks>
        /// Custom handling is needed to allow borderless windows to maximize without overlapping the task bar.
        /// Keeping the taskbar visible is desired by most themes. However, in cases where borderless windows
        /// are supposed to overlap the taskbar, this property can be set to false.
        /// </remarks>
        public static readonly DependencyProperty HandleCustomMinMaxProperty = DependencyProperty.RegisterAttached("HandleCustomMinMax", typeof(bool), typeof(WindowEx), new PropertyMetadata(true));
        ...
        /// are supposed to overlap the taskbar, this property can be set to false.
        /// </remarks>
        public static bool GetHandleCustomMinMax(DependencyObject d) => (bool)d.GetValue(HandleCustomMinMaxProperty);

        /// <summary>
        /// Defines whether CODE Framework's custom min/max handling kicks in (default) or not.
        /// </summary>
        /// <param name="d">The dependency object the value is to be set on.</param>
        /// <param name="value">Value.</param>
        /// <remarks>Custom handling is needed to allow borderless windows to maximize without overlapping the task bar.
        /// Keeping the taskbar visible is desired by most themes. However, in cases where borderless windows
        /// are supposed to overlap the taskbar, this property can be set to false.</remarks>
        public static void SetHandleCustomMinMax(DependencyObject d, bool value) => d.SetValue(HandleCustomMinMaxProperty, value);

        /// <summary>
        /// Indicates whether and when the window shall have a drop shadow
        /// </summary>
        ...
        /// </summary>
        public static EffectActiveStates GetHasDropShadow(DependencyObject obj) => (EffectActiveStates)obj.GetValue(HasDropShadowProperty);

        /// <summary>
        /// Indicates whether and when the window shall have a drop shaddow
        /// </summary>
        public static void SetHasDropShadow(DependencyObject obj, EffectActiveStates value) => obj.SetValue(HasDropShadowProperty, value);
        ...
        private static IntPtr WindowHook(IntPtr hwnd, int msg, IntPtr wParam, IntPtr lParam, ref bool handled)
        {
            switch (msg)
            {
                case 0x0024: /* WM_GETMINMAXINFO */
                    ...
                    if (window != null)
                        mustHandle = GetHandleCustomMinMax(window);
        ...
        internal struct InteropRect
        {
            ...
            /// <summary> Win32 </summary>
            public bool IsEmpty => left >= right || top >= bottom; // BUGBUG : On Bidi OS (hebrew arabic) left > right
        }
        ...
        private static void SetWindowVisualRect(Rect windowRectangle, Window window)
        {
            ...
            NativeMethods.SetWindowPos(mainWindowSource.Handle, IntPtr.Zero, (int)deviceTopLeft.X, (int)deviceTopLeft.Y, (int)Math.Abs(deviceBottomRight.X - deviceTopLeft.X), (int)Math.Abs(deviceBottomRight.Y - deviceTopLeft.Y), 0);
        }
        ...
        {
            if (Mouse.Captured is Window win)
            {
                win.MouseMove -= WindowResizeMouseDownMoveHandler;
                Mouse.Capture(null);
            }
        ...
        /// <summary>If true, the window allows resizing, even if the window is a borderless window</summary>
        public static bool GetAutoWindowResizingEnabled(DependencyObject obj) => (bool)obj.GetValue(AutoWindowResizingEnabledProperty);

        /// <summary>If true, the window allows resizing, even if the window is a borderless window</summary>
        public static void SetAutoWindowResizingEnabled(DependencyObject obj, bool value) => obj.SetValue(AutoWindowResizingEnabledProperty, value);
        ...
        private static extern int DwmExtendFrameIntoClientArea(IntPtr hWnd, ref MarginsLocal pMarInset);
        ...
        private static bool DropShadow(Window window)
        {
            try
            {
                ...
                if (result == 0)
                {
                    var margins = new MarginsLocal { Left = 0, Top = 0, Right = 0, Bottom = 1 };
