...
namespace CODE.Framework.Wpf.Controls
{
    ...
    public class Ex : DependencyObject
    {
        ...
        {
            if (d is FrameworkElement e2 && e.NewValue is EventCommand c) c.SetUIElement(e2);
            if (d is FrameworkContentElement e3 && e.NewValue is EventCommand c2) c2.SetUIElement(e3);
        }
        ...
        public static EventCommand GetEventCommand(DependencyObject obj) => (EventCommand)obj.GetValue(EventCommandProperty);

        /// <summary>Event command</summary>
        /// <param name="obj">Object to set the event command on</param>
        /// <param name="value">Value to set</param>
        public static void SetEventCommand(DependencyObject obj, EventCommand value) => obj.SetValue(EventCommandProperty, value);
        ...
        {
            if (d is FrameworkElement e2 && e.NewValue is EventCommandsCollection commands)
            {
                commands.SetUIElement(e2);
                foreach (var eventCommand in commands)
                    commands.ConfigureEventCommand(eventCommand);
            }
            if (d is FrameworkContentElement e3 && e.NewValue is EventCommandsCollection commands2)
            {
                commands2.SetUIElement(e3);
                foreach (var eventCommand in commands2)
                    commands2.ConfigureEventCommand(eventCommand);
            }
        }
        ...
        /// <returns>Event command</returns>
        /// <remarks>This attached property can be attached to any UI Element to define an event command</remarks>
        public static EventCommandsCollection GetEventCommands(DependencyObject obj) => (EventCommandsCollection)obj.GetValue(EventCommandsProperty);

        /// <summary>Event commands</summary>
        /// <param name="obj">Object to set the event command on</param>
        /// <param name="value">Value to set</param>
        public static void SetEventCommands(DependencyObject obj, EventCommandsCollection value) => obj.SetValue(EventCommandsProperty, value);
        ...
        {
            if ((bool)e.NewValue && d is TextBoxBase t)
                t.GotFocus += (s, e2) => t.SelectAll();
        }

        /// <summary>Defines whether an object (such as a textbox) automatically is selected when focus moves into it</summary>
        /// <param name="obj">The object to set the value on</param>
        /// <param name="value">True for auto-select</param>
        public static void SetSelectOnEntry(DependencyObject obj, bool value) => obj.SetValue(SelectOnEntryProperty, value);

        /// <summary>Defines whether an object (such as a textbox) automatically is selected when focus moves into it</summary>
        /// <param name="obj">The object to retrieve the value for</param>
        /// <returns>True if auto-select</returns>
        public static bool GetSelectOnEntry(DependencyObject obj) => (bool)obj.GetValue(SelectOnEntryProperty);
    }
    ...
    public class EventCommand : FrameworkElement
    {
        ...
        /// <summary>Event that is to fire the command</summary>
        public static readonly DependencyProperty EventProperty = DependencyProperty.Register("Event", typeof(string), typeof(EventCommand), new UIPropertyMetadata("", (d, e) =>
        {
            if (d is EventCommand d2)
                d2.HookEvent();
        }));
        ...
        /// <summary>Command that is to be executed when the desired event fires.</summary>
        public static readonly DependencyProperty CommandProperty = DependencyProperty.Register("Command", typeof(ICommand), typeof(EventCommand), new UIPropertyMetadata(null, (d, e) =>
        {
            if (d is EventCommand d2)
                d2.HookEvent();
        }));
        ...
        /// <summary>Command parameter associated with the command.</summary>
        public static readonly DependencyProperty CommandParameterProperty = DependencyProperty.Register("CommandParameter", typeof(object), typeof(EventCommand), new UIPropertyMetadata(null, (d, e) =>
        {
            if (d is EventCommand d2)
                d2.HookEvent();
        }));
    ...
    public class EventCommandsCollection : ObservableCollection<EventCommand>
    {
        ...
        public EventCommandsCollection()
        {
            ...
            {
                foreach (var command in e.NewItems.OfType<EventCommand>())
                    ConfigureEventCommand(command);
            };
        }

        /// <summary>Called ot set the UI element this event command belongs to.</summary>
        /// <param name="attachedTo">Associated object  </param>
        public void SetUIElement(FrameworkElement attachedTo) => _attachedTo = attachedTo;

        /// <summary>Called ot set the UI element this event command belongs to.</summary>
        /// <param name="attachedTo">Associated object  </param>
        public void SetUIElement(FrameworkContentElement attachedTo) => _attachedTo2 = attachedTo;
