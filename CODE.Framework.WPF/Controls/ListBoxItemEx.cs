...
namespace CODE.Framework.Wpf.Controls
{
    ...
    public class ListBoxItemEx : ListBoxItem
    {
        ...
        /// <summary>
        /// Selects the item when focus within changed.
        /// </summary>
        ...
        /// <returns></returns>
        public static bool GetSelectItemWhenFocusWithin(DependencyObject o) => (bool)o.GetValue(SelectItemWhenFocusWithinProperty);
        ...
        public static void SetSelectItemWhenFocusWithin(DependencyObject o, bool value) => o.SetValue(SelectItemWhenFocusWithinProperty, value);
    }
}
