...
namespace CODE.Framework.Wpf.Controls
{
    ...
    public class ListBoxFastGridHeader : Panel
    {
        ...
        {
            if (o is not ListBoxFastGridHeader header) return;
            ...
            columns.CollectionChanged += (o2, a) =>
            {
                ...
                {
                    if (item is ListColumn newColumn) newColumns.Add(newColumn);
                }
        ...
        {
            if (d is not ListBoxFastGridHeader header) return;
        ...
        protected virtual void RenderStandardHeaderElements(DrawingContext dc, double headerHeight) => dc.DrawLine(GetGridLinePen(), new Point(0d, headerHeight - .5d), new Point(ActualWidth, headerHeight - .5d));
        ...
        /// </summary>
        /// <returns>Pen</returns>
        protected virtual Pen GetGridLinePen() => _gridLinePen ?? (_gridLinePen = new Pen(GridLineColor, 1d));
