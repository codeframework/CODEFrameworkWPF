...
{
    /// <summary>Extended version of the windows application object</summary>
    public class ApplicationEx : Application
    {
        /// <summary>The standard theme features (internal use only)</summary>
        private static readonly Dictionary<string, StandardThemeFeatureWrapper> StandardThemeFeatures = new();

        /// <summary>Internal list of registered themes</summary>
        private static readonly Dictionary<string, string> RegisteredThemes = new();

        /// <summary>List of secondary assemblies the current app references.</summary>
        public static Dictionary<string, Assembly> SecondaryAssemblies = new();
        ...
        /// <summary>Forces a re-load of the current theme</summary>
        public void LoadTheme()
        {
            if (string.IsNullOrEmpty(Theme)) return;

            BeforeThemeSwitch?.Invoke(this, new ThemeSwitchEventArgs { NewTheme = _theme, OldTheme = _oldTheme });
            ...
            ThemeSwitched?.Invoke(this, new ThemeSwitchEventArgs { NewTheme = _theme, OldTheme = _oldTheme });
