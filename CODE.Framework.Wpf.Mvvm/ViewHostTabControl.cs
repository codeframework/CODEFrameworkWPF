...
namespace CODE.Framework.Wpf.Mvvm
{
    ...
    public class ViewHostTabControl : TabControl
    {
        ...
        {
            get => GetValue(MainModelProperty);
        ...
        {
            get => (double)GetValue(ContentZoomProperty);
        ...
        {
            get => (bool)GetValue(HasVisibleItemsProperty);
        ...
        {
            get => (bool)GetValue(HasVisibleLocalViewsProperty);
    ...
    public class HierarchicalViewHostTabControl : ViewHostTabControl
    {
        ...
        {
            get => (int)GetValue(ActivateViewIndexProperty);
        ...
        {
            if (d is not HierarchicalViewHostTabControl tabs) return;
        ...
        protected override void HandleSelectionChanged()
        {
            ...
            if (Items[SelectedIndex] is not TabItem tab) return;
            if (tab.Content is not TabControl subTabControl) return;
            if (subTabControl.SelectedIndex < 0)
            {
                if (SelectedViewResult != null) SelectedViewResult = null;
                return;
            }
            if (subTabControl.Items[subTabControl.SelectedIndex] is not TabItem tab2) return;
        ...
        {
            get => (ViewResult)GetValue(SelectedViewResultProperty);
        ...
        {
            get => (string)GetValue(EmptyGroupTitleProperty);
        ...
        {
            get => (bool)GetValue(CombineAllEmptyGroupsProperty);
        ...
        public static string GetAssociatedGroupName(DependencyObject dep) => (string)dep.GetValue(AssociatedGroupNameProperty);
        /// <summary>
        /// For internal use only
        /// </summary>
        /// <param name="dep">The object the property was set on</param>
        /// <param name="value">The associated group name.</param>
        public static void SetAssociatedGroupName(DependencyObject dep, string value) => dep.SetValue(AssociatedGroupNameProperty, value);
        ...
        {
            get => (ObservableCollection<ViewResult>)GetValue(HierarchicalViewsProperty);
        ...
        {
            get => (Style)GetValue(SubTabControlStyleProperty);
        ...
        private static void OnHierarchicalViewsChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            if (d is not HierarchicalViewHostTabControl tabs) return;
            tabs.RepopulateViews();
            if (e.NewValue is ObservableCollection<ViewResult> views)
        ...
        private void RemoveViews(List<ViewResult> removedViewResults)
        {
            ...
            foreach (var groupPage in Items.OfType<TabItem>())
            {
                ...
                if (groupPage.Content is not TabControl subTabControl) continue;
    ...
    public class HierarchicalViewHostTabItem : TabItem
    {
        ...
        {
            get => (Style)GetValue(UndockWindowStyleProperty);
        ...
        {
            if (Content is not ViewResult viewResult) return;
    ...
    public class UndockedHierarchicalViewWindow : Window
    {
        ...
        /// </summary>
        public void DockContent() => _hierarchicalViewHostTabItem.DockContent();
    }
    ...
    public class TopLevelViewHostTabControl : ViewHostTabControl
    {
        ...
        {
            get => (UIElement)GetValue(NormalViewHostProperty);
        ...
        {
            get => (bool)GetValue(DisableNormalViewHostWhenTopLevelIsActiveProperty);
        ...
        public static bool GetInputBindingsSet(DependencyObject obj) => (bool)obj.GetValue(InputBindingsSetProperty);

        /// <summary>InputBindingsSet</summary>
        /// <param name="obj">Object to set the value on</param>
        /// <param name="value">Value to set</param>
        public static void SetInputBindingsSet(DependencyObject obj, bool value) => obj.SetValue(InputBindingsSetProperty, value);
