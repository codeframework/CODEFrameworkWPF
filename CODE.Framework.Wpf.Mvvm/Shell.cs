...
namespace CODE.Framework.Wpf.Mvvm
{
    ...
    public class Shell : Window, IViewHandler
    {
        ...
        public Shell()
        {
            ...
            Current = this;
            SetSetAsActiveShellContextWindow(this, true);
        ...
        {
            get => (ObservableCollection<ViewResult>)GetValue(TopLevelViewsProperty);
        ...
        {
            get => (ViewLaunchMode)GetValue(TopLevelViewLaunchModeProperty);
        ...
        {
            get => (int)GetValue(MaximumTopLevelViewCountProperty);
        ...
        {
            get => (ObservableCollection<ViewResult>)GetValue(NormalViewsProperty);
        ...
        {
            get => (ViewLaunchMode)GetValue(NormalViewLaunchModeProperty);
        ...
        {
            get => (int)GetValue(MaximumNormalViewCountProperty);
        ...
        {
            get => (int)GetValue(SelectedNormalViewProperty);
        ...
        {
            get => (double)GetValue(DesiredContentZoomFactorProperty);
        ...
        private static void OnSelectedNormalViewChanged(DependencyObject source, DependencyPropertyChangedEventArgs args)
        {
            ...
            switch (shell.TitleMode)
            {
                ...
                case ShellTitleMode.OriginalTitleDashViewTitle:
                    shell.NormalViews[viewIndex].PropertyChanged -= shell.HandleViewTitleChanged;
                    shell.NormalViews[viewIndex].PropertyChanged += shell.HandleViewTitleChanged;
        ...
        private void HandleViewTitleChanged(object sender, PropertyChangedEventArgs e)
        {
            if (e.PropertyName == nameof(ViewResult.ViewTitle))
                OnSelectedNormalViewChanged(this, new DependencyPropertyChangedEventArgs(SelectedNormalViewProperty, SelectedNormalView, SelectedNormalView));
        }
        ...
        {
            get => (ViewResult)GetValue(SelectedNormalViewResultProperty);
        ...
        {
            get => (int)GetValue(NormalViewCountProperty);
        ...
        {
            get => (int)GetValue(SelectedTopLevelViewProperty);
        ...
        private static void OnSelectedTopLevelViewChanged(DependencyObject source, DependencyPropertyChangedEventArgs args)
        {
            ...
            if (view is IUserInterfaceActivation activatingView) activatingView.RaiseActivated();
        }

        /// <summary>
        /// This property is set whenever an existing view needs to be activated
        /// </summary>
        /// <value>The view result to activate.</value>
        public ViewResult ViewResultToActivate
        {
            get => (ViewResult)GetValue(ViewResultToActivateProperty);
            set { SetValue(ViewResultToActivateProperty, value); }
        }

        /// <summary>
        /// This property is set whenever an existing view needs to be activated
        /// </summary>
        public static readonly DependencyProperty ViewResultToActivateProperty = DependencyProperty.Register("ViewResultToActivate", typeof(ViewResult), typeof(Shell), new PropertyMetadata(null));
        ...
        {
            get => (int)GetValue(ViewIndexToActivateProperty);
        ...
        {
            get => (int)GetValue(TopViewIndexToActivateProperty);
        ...
        {
            get => (ViewResult)GetValue(SelectedTopLevelViewResultProperty);
        ...
        {
            get => (int)GetValue(TopLevelViewCountProperty);
        ...
        {
            get => (StatusViewResultWrapper)GetValue(StatusProperty);
        ...
        {
            get => (UIElement)GetValue(CurrentStatusViewProperty);
        ...
        {
            get => (ApplicationStatus)GetValue(CurrentApplicationStatusProperty);
        ...
        {
            get => (int)GetValue(MaximumNotificationCountProperty);
        ...
        {
            get => (ObservableCollection<NotificationViewResultWrapper>)GetValue(CurrentNotificationsProperty);
        ...
        /// <summary>List of currently open notifications (associated as an attached property with any given View object)</summary>
        public static readonly DependencyProperty CurrentNotificationsAttachedProperty = DependencyProperty.RegisterAttached("CurrentNotificationsAttached", typeof(ObservableCollection<NotificationViewResultWrapper>), typeof(Shell), new UIPropertyMetadata(new ObservableCollection<NotificationViewResultWrapper>()));

        /// <summary>List of currently open notifications (associated as an attached property with any given View object)</summary>
        /// <param name="d">View (or any dependency object)</param>
        public static ObservableCollection<NotificationViewResultWrapper> GetCurrentNotificationsAttached(DependencyObject d) => (ObservableCollection<NotificationViewResultWrapper>)d.GetValue(CurrentNotificationsAttachedProperty);

        /// <summary>List of currently open notifications (associated as an attached property with any given View object)</summary>
        /// <param name="d">View (or any dependency object)</param>
        /// <param name="value">The value.</param>
        public static void SetCurrentNotificationsAttached(DependencyObject d, ObservableCollection<NotificationViewResultWrapper> value) => d.SetValue(CurrentNotificationsAttachedProperty, value);

        /// <summary>Indicates number of currently displayed notifications</summary>
        public int CurrentNotificationsCount
        {
            get => (int)GetValue(CurrentNotificationsCountProperty);
        ...
        {
            get => (NotificationSort)GetValue(NotificationSortProperty);
        ...
        /// <summary>Defines whether notifications for top-level views appear in the main shell (default) or with the actual top-level view</summary>
        public NotificationDisplayMode NotificationDisplayMode
        {
            get => (NotificationDisplayMode)GetValue(NotificationDisplayModeProperty);
            set => SetValue(NotificationDisplayModeProperty, value);
        }
        /// <summary>Defines whether notifications for top-level views appear in the main shell (default) or with the actual top-level view</summary>
        public static readonly DependencyProperty NotificationDisplayModeProperty = DependencyProperty.Register("NotificationDisplayMode", typeof(NotificationDisplayMode), typeof(Shell), new PropertyMetadata(NotificationDisplayMode.Shell));

        /// <summary>Defines what should show in the title bar of the shell window</summary>
        public ShellTitleMode TitleMode
        {
            get => (ShellTitleMode)GetValue(TitleModeProperty);
        ...
        {
            get => (bool)GetValue(HandleLocalViewsSpecialProperty);
            set => SetValue(HandleLocalViewsSpecialProperty, value);
        }

        /// <summary>Currently active window, which will be used for things such as the owner of modal windows</summary>
        public Window ContextWindow
        {
            get => contextWindow ?? Current;
        ...
        protected virtual bool HandleNotificationMessage(RequestContext context, TimeSpan? overrideTimeout = null)
        {
            ...
            var currentNotifications = CurrentNotifications;
            // If the shell is set to show notifications with context in special views, we need to check for this
            if (NotificationDisplayMode == NotificationDisplayMode.WithSpecifiedViewModel && wrapper.Model.AssociatedViewModel != null)
            {
                var mustFindTopLevelView = true;
                foreach (var viewResult in NormalViews)
                    if (viewResult.Model == wrapper.Model.AssociatedViewModel)
                    {
                        mustFindTopLevelView = false; // Since the associated model isn't in a top-level view, there is no need to do anything special
                        break;
                    }

                if (mustFindTopLevelView)
                {
                    foreach (var viewResult in TopLevelViews)
                        if (viewResult.Model == wrapper.Model.AssociatedViewModel && viewResult.View != null)
                        {
                            // This is the one. Therefore, we send the notifications into that View using attached properties, which will (hopefully) be picked up by the defined template for that view.
                            var currentNotificationsLocal = GetCurrentNotificationsAttached(viewResult.View);
                            if (currentNotificationsLocal != null)
                            {
                                currentNotifications = currentNotificationsLocal;
                                break;
                            }
                        }
                }
            ...
            // TODO: The count is wrong when notifications go to the top-level view
        ...
        public bool OpenView(RequestContext context)
        {
            ...
            if (context.Result is ExistingViewResult existingViewResult)
            ...
            if (messageBoxResult != null)
            {
                ...
                {
                    if (messageBoxResult.Model is MessageBoxViewModel messageBoxViewModel)
                    {
                ...
                if (messageBoxResult.View != null)
                {
                    if (messageBoxResult.Model is IHaveActions messageBoxModelAction)
                    {
        ...
        public bool ActivateViewForModel(object model)
        {
            ...
            foreach (var view in TopLevelViews)
            {
                ...
                if (view.Model != null && view.Model == model)
                {
                    ...
                    ViewResultToActivate = null;
                    ViewResultToActivate = view;
        ...
        public void SetOriginalTitle(string originalTitle) => _originalTitle = originalTitle;
        ...
        /// <summary>
        /// If this property is set to true on a Window, the window will be considered the "context" window (which will be the owner of modal windows, such as message boxes).
        /// </summary>
        public static readonly DependencyProperty SetAsActiveShellContextWindowProperty = DependencyProperty.RegisterAttached("SetAsActiveShellContextWindow", typeof(bool), typeof(Window), new PropertyMetadata(false, SetAsActiveShellContextWindowChanged));

        /// <summary>
        /// Fires when the SetAsActiveShellContextWindow property changes
        /// </summary>
        /// <param name="d">The d.</param>
        /// <param name="e">The <see cref="DependencyPropertyChangedEventArgs"/> instance containing the event data.</param>
        private static void SetAsActiveShellContextWindowChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            if (!(d is Window window)) return;
            if ((bool)e.NewValue)
                window.Activated += (s, e2) =>
                {
                    if (s is Window contextWindow)
        ...
        /// If this property is set to true on a Window, the window will be considered the "context" window (which will be the owner of modal windows, such as message boxes).
        /// </summary>
        public static bool GetSetAsActiveShellContextWindow(DependencyObject obj) => (bool)obj.GetValue(SetAsActiveShellContextWindowProperty);

        /// <summary>
        /// If this property is set to true on a Window, the window will be considered the "context" window (which will be the owner of modal windows, such as message boxes).
        /// </summary>
        public static void SetSetAsActiveShellContextWindow(DependencyObject obj, bool value) => obj.SetValue(SetAsActiveShellContextWindowProperty, value);

        /// <summary>
        /// If a window is a top-level window launched by the shell due to a view being opened, this property is set to the underlying view result
        /// </summary>
        public static readonly DependencyProperty ViewResultProperty = DependencyProperty.RegisterAttached("ViewResult", typeof(ViewResult), typeof(Window), new PropertyMetadata(null, ViewResultChanged));

        /// <summary>
        /// Fires when the ViewResult property changes
        /// </summary>
        /// <param name="d">The d.</param>
        /// <param name="e">The <see cref="DependencyPropertyChangedEventArgs"/> instance containing the event data.</param>
        private static void ViewResultChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
        }
        ...
        /// If a window is a top-level window launched by the shell due to a view being opened, this property is set to the underlying view result
        /// </summary>
        public static ViewResult GetViewResult(DependencyObject obj) => (ViewResult)obj.GetValue(ViewResultProperty);

        /// <summary>
        /// If a window is a top-level window launched by the shell due to a view being opened, this property is set to the underlying view result
        /// </summary>
        public static void SetViewResult(DependencyObject obj, ViewResult value) => obj.SetValue(ViewResultProperty, value);
    }
    ...
    /// <summary>
    /// Defines where notifications appear
    /// </summary>
    public enum NotificationDisplayMode
    {
        /// <summary>
        /// Notifications always appear inside the main shell window
        /// </summary>
        Shell,
        /// <summary>
        /// Notifications appear in the view associated with the specified view-model. If no model is specified, the notification appears in the Shell
        /// </summary>
        WithSpecifiedViewModel
    }
