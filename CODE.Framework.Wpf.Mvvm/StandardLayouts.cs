namespace CODE.Framework.Wpf.Mvvm
{
    ...
    public enum StandardLayouts
    {
        ...
        FlowForm,
        /// <summary>
        /// Multi-panel layouts arrange controls horizontally, using up all available space.
        /// </summary>
        MultiPanel,
        /// <summary>
        /// Multi-panel layouts arrange controls horizontally, using up all available space.
        ...
        /// <summary>
        /// Multi-panel layouts arrange controls vertically, using up all available space.
        /// </summary>
        MultiPanelHorizontal,
        /// <summary>
        /// Multi-panel layouts arrange controls either vertically, using up all available space.
        /// This version includes headers.
        /// </summary>
        MultiPanelHorizontalWithHeaders,
        /// <summary>
    ...
    public static class StandardLayoutHelper
    {
        ...
        static StandardLayoutHelper()
        {
            ...
            StandardLayoutMaps.Add(StandardLayouts.MultiPanelHorizontal, "CODE.Framework-Layout-MultiPanelHorizontalLayout");
            StandardLayoutMaps.Add(StandardLayouts.MultiPanelHorizontalWithHeaders, "CODE.Framework-Layout-MultiPanelHorizontalWithHeaderLayout");
            ...
            StandardLayoutMapsBackward.Add("CODE.Framework-Layout-MultiPanelHorizontalLayout", StandardLayouts.MultiPanelHorizontal);
            StandardLayoutMapsBackward.Add("CODE.Framework-Layout-MultiPanelHorizontalWithHeaderLayout", StandardLayouts.MultiPanelHorizontalWithHeaders);
            ...
            StandardLayoutTitles.Add(StandardLayouts.MultiPanelHorizontal, "Multi-Panel Layout (vertical)");
            StandardLayoutTitles.Add(StandardLayouts.MultiPanelHorizontalWithHeaders, "Multi-Panel Layout with Headers (vertical)");
            ...
            StandardLayoutDescriptions.Add(StandardLayouts.MultiPanel, "Multi-panel layouts arrange controls vertical, using up all available space.");
            StandardLayoutDescriptions.Add(StandardLayouts.MultiPanelWithHeaders, "Multi-panel layouts arrange controls vertical, using up all available space.\r\nThis version includes headers.");
            StandardLayoutDescriptions.Add(StandardLayouts.MultiPanelHorizontal, "Multi-panel layouts arrange controls horizontal, using up all available space.");
            StandardLayoutDescriptions.Add(StandardLayouts.MultiPanelHorizontalWithHeaders, "Multi-panel layouts arrange controls horizontal, using up all available space.\r\nThis version includes headers.");
        ...
        public static StandardLayouts GetStandardLayoutEnumFromKey(string layoutKey) => StandardLayoutMapsBackward.ContainsKey(layoutKey) ? StandardLayoutMapsBackward[layoutKey] : StandardLayouts.None;
        ...
        public static string GetStandardLayoutKeyFromEnum(StandardLayouts layout) => StandardLayoutMaps.ContainsKey(layout) ? StandardLayoutMaps[layout] : string.Empty;
        ...
        public static string GetStandardLayoutDescription(StandardLayouts layout) => StandardLayoutDescriptions.ContainsKey(layout) ? StandardLayoutDescriptions[layout] : string.Empty;
        ...
        public static string GetStandardLayoutTitle(StandardLayouts layout) => StandardLayoutTitles.ContainsKey(layout) ? StandardLayoutTitles[layout] : string.Empty;
    }
}
