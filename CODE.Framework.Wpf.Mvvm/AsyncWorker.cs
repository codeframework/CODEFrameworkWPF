...
namespace CODE.Framework.Wpf.Mvvm
{
    ...
    public static class AsyncWorker
    {
        ...
        public static bool AttemptToHandleBackgroundExceptions { get; set; } = false;
        ...
        public static bool AssignDefaultValuesToDefaultObjectByConvention { get; set; } = true;
        ...
        /// <param name="viewAction">When a view-action is passed, AsyncWorker automatically handles its IsBusy flag by setting it to true as long as the operation is going on</param>
        /// <param name="viewActions">When a view-action list is passed, AsyncWorker automatically handles all the contained view-action's IsBusy flag by setting it to true as long as the operation is going on</param>
        public static void Execute<TResult>(Func<TResult> worker, Action<TResult> completeMethod, IModelStatus statusObject = null, ModelStatus operationStatus = ModelStatus.Loading, IViewAction viewAction = null, IEnumerable<IViewAction> viewActions = null)
        {
            SetModelStatusThreadSafe(statusObject, operationStatus, 1);
            if (viewAction != null) SetViewActionBusyThreadSafe(viewAction, 1);
            if (viewActions != null) foreach (var viewAction2 in viewActions) SetViewActionBusyThreadSafe(viewAction2, 1);

            // TODO: This needs to be fixed up, where all the commented code below is taken care of.

            var task = Task.Run(() => worker.Invoke());
            task.ContinueWith(async (ar) =>
            {
                var result = ar.Result;
                Application.Current.Dispatcher.BeginInvoke(new Action<Action<TResult>, TResult, IModelStatus, IViewAction, IEnumerable<IViewAction>>(ExecuteDispatch), completeMethod, result, statusObject, viewAction, viewActions);
            });
            ...
            //            Application.Current.Dispatcher.BeginInvoke(new Action<Action<TResult>, TResult, IModelStatus, IViewAction, IEnumerable<IViewAction>>(ExecuteDispatch), completeMethod, defaultInstance, statusObject, viewAction, viewActions);
            //        }
            //        catch (Exception)
            //        {
        ...
        /// <param name="viewAction">When a view-action is passed, AsyncWorker automatically handles its IsBusy flag by setting it to true as long as the operation is going on</param>
        /// <param name="viewActions">When a view-action list is passed, AsyncWorker automatically handles all the contained view-action's IsBusy flag by setting it to true as long as the operation is going on</param>
        public static void Execute<TResult, TResult2>(Func<TResult> worker, Func<TResult2> worker2, Action<TResult, TResult2> completeMethod, IModelStatus statusObject = null, ModelStatus operationStatus = ModelStatus.Loading, IViewAction viewAction = null, IEnumerable<IViewAction> viewActions = null)
        {
            SetModelStatusThreadSafe(statusObject, operationStatus, 1);
            if (viewAction != null) SetViewActionBusyThreadSafe(viewAction, 1);
            if (viewActions != null) foreach (var viewAction2 in viewActions) SetViewActionBusyThreadSafe(viewAction2, 1);
        ...
        /// <param name="viewAction">When a view-action is passed, AsyncWorker automatically handles its IsBusy flag by setting it to true as long as the operation is going on</param>
        /// <param name="viewActions">When a view-action list is passed, AsyncWorker automatically handles all the contained view-action's IsBusy flag by setting it to true as long as the operation is going on</param>
        public static void Execute<TResult, TResult2, TResult3>(Func<TResult> worker, Func<TResult2> worker2, Func<TResult3> worker3, Action<TResult, TResult2, TResult3> completeMethod, IModelStatus statusObject = null, ModelStatus operationStatus = ModelStatus.Loading, IViewAction viewAction = null, IEnumerable<IViewAction> viewActions = null)
        {
            SetModelStatusThreadSafe(statusObject, operationStatus, 1);
            if (viewAction != null) SetViewActionBusyThreadSafe(viewAction, 1);
            // ReSharper disable once PossibleMultipleEnumeration
        ...
        /// <param name="viewAction">When a view-action is passed, AsyncWorker automatically handles its IsBusy flag by setting it to true as long as the operation is going on</param>
        /// <param name="viewActions">When a view-action list is passed, AsyncWorker automatically handles all the contained view-action's IsBusy flag by setting it to true as long as the operation is going on</param>
        public static void Execute<TResult, TResult2, TResult3, TResult4>(Func<TResult> worker, Func<TResult2> worker2, Func<TResult3> worker3, Func<TResult4> worker4, Action<TResult, TResult2, TResult3, TResult4> completeMethod, IModelStatus statusObject = null, ModelStatus operationStatus = ModelStatus.Loading, IViewAction viewAction = null, IEnumerable<IViewAction> viewActions = null)
        {
            SetModelStatusThreadSafe(statusObject, operationStatus, 1);
            if (viewAction != null) SetViewActionBusyThreadSafe(viewAction, 1);
            // ReSharper disable once PossibleMultipleEnumeration
        ...
        /// <param name="viewAction">When a view-action is passed, AsyncWorker automatically handles its IsBusy flag by setting it to true as long as the operation is going on</param>
        /// <param name="viewActions">When a view-action list is passed, AsyncWorker automatically handles all the contained view-action's IsBusy flag by setting it to true as long as the operation is going on</param>
        public static void Execute<TResult, TResult2, TResult3, TResult4, TResult5>(Func<TResult> worker, Func<TResult2> worker2, Func<TResult3> worker3, Func<TResult4> worker4, Func<TResult5> worker5, Action<TResult, TResult2, TResult3, TResult4, TResult5> completeMethod, IModelStatus statusObject = null, ModelStatus operationStatus = ModelStatus.Loading, IViewAction viewAction = null, IEnumerable<IViewAction> viewActions = null)
        {
            SetModelStatusThreadSafe(statusObject, operationStatus, 1);
            if (viewAction != null) SetViewActionBusyThreadSafe(viewAction, 1);
            // ReSharper disable once PossibleMultipleEnumeration
        ...
        /// <param name="viewAction">When a view-action is passed, AsyncWorker automatically handles its IsBusy flag by setting it to true as long as the operation is going on</param>
        /// <param name="viewActions">When a view-action list is passed, AsyncWorker automatically handles all the contained view-action's IsBusy flag by setting it to true as long as the operation is going on</param>
        public static void Execute<TResult, TResult2, TResult3, TResult4, TResult5, TResult6>(Func<TResult> worker, Func<TResult2> worker2, Func<TResult3> worker3, Func<TResult4> worker4, Func<TResult5> worker5, Func<TResult6> worker6, Action<TResult, TResult2, TResult3, TResult4, TResult5, TResult6> completeMethod, IModelStatus statusObject = null, ModelStatus operationStatus = ModelStatus.Loading, IViewAction viewAction = null, IEnumerable<IViewAction> viewActions = null)
        {
            SetModelStatusThreadSafe(statusObject, operationStatus, 1);
            if (viewAction != null) SetViewActionBusyThreadSafe(viewAction, 1);
            // ReSharper disable once PossibleMultipleEnumeration
        ...
        /// <param name="viewAction">When a view-action is passed, AsyncWorker automatically handles its IsBusy flag by setting it to true as long as the operation is going on</param>
        /// <param name="viewActions">When a view-action list is passed, AsyncWorker automatically handles all the contained view-action's IsBusy flag by setting it to true as long as the operation is going on</param>
        public static void Execute<TResult, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7>(Func<TResult> worker, Func<TResult2> worker2, Func<TResult3> worker3, Func<TResult4> worker4, Func<TResult5> worker5, Func<TResult6> worker6, Func<TResult7> worker7, Action<TResult, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7> completeMethod, IModelStatus statusObject = null, ModelStatus operationStatus = ModelStatus.Loading, IViewAction viewAction = null, IEnumerable<IViewAction> viewActions = null)
        {
            SetModelStatusThreadSafe(statusObject, operationStatus, 1);
            if (viewAction != null) SetViewActionBusyThreadSafe(viewAction, 1);
            // ReSharper disable once PossibleMultipleEnumeration
        ...
        /// <param name="viewAction">When a view-action is passed, AsyncWorker automatically handles its IsBusy flag by setting it to true as long as the operation is going on</param>
        /// <param name="viewActions">When a view-action list is passed, AsyncWorker automatically handles all the contained view-action's IsBusy flag by setting it to true as long as the operation is going on</param>
        public static void Execute<TResult, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7, TResult8>(Func<TResult> worker, Func<TResult2> worker2, Func<TResult3> worker3, Func<TResult4> worker4, Func<TResult5> worker5, Func<TResult6> worker6, Func<TResult7> worker7, Func<TResult8> worker8, Action<TResult, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7, TResult8> completeMethod, IModelStatus statusObject = null, ModelStatus operationStatus = ModelStatus.Loading, IViewAction viewAction = null, IEnumerable<IViewAction> viewActions = null)
        {
            SetModelStatusThreadSafe(statusObject, operationStatus, 1);
            if (viewAction != null) SetViewActionBusyThreadSafe(viewAction, 1);
            // ReSharper disable once PossibleMultipleEnumeration
        ...
        /// <param name="viewAction">When a view-action is passed, AsyncWorker automatically handles its IsBusy flag by setting it to true as long as the operation is going on</param>
        /// <param name="viewActions">When a view-action list is passed, AsyncWorker automatically handles all the contained view-action's IsBusy flag by setting it to true as long as the operation is going on</param>
        public static void Execute<TResult, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7, TResult8, TResult9, TResult10, TResult11>(Func<TResult> worker, Func<TResult2> worker2, Func<TResult3> worker3, Func<TResult4> worker4, Func<TResult5> worker5, Func<TResult6> worker6, Func<TResult7> worker7, Func<TResult8> worker8, Func<TResult9> worker9, Func<TResult10> worker10, Func<TResult11> worker11, Action<TResult, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7, TResult8, TResult9, TResult10, TResult11> completeMethod, IModelStatus statusObject = null, ModelStatus operationStatus = ModelStatus.Loading, IViewAction viewAction = null, IEnumerable<IViewAction> viewActions = null)
        {
            SetModelStatusThreadSafe(statusObject, operationStatus, 1);
            if (viewAction != null) SetViewActionBusyThreadSafe(viewAction, 1);
            // ReSharper disable once PossibleMultipleEnumeration
        ...
        /// <param name="viewAction">If a view-action is passed, its busy status will be handled automatically</param>
        /// <param name="viewActions">If a view-action list is passed, the busy status of all contained view-actions will be handled automatically</param>
        private static void ExecuteDispatch<TResult>(Action<TResult> completeMethod, TResult parameter, IModelStatus statusObject, IViewAction viewAction = null, IEnumerable<IViewAction> viewActions = null)
        {
        ...
        public static bool PauseContinuousProcess(Guid processId)
        {
            ...
            if (!_intervalProcesses.ContainsKey(processId)) return false;
        ...
        public static bool StopContinuousProcess(Guid processId)
        {
            if (_intervalProcesses == null) return false;
            if (!_intervalProcesses.ContainsKey(processId)) return false;
            lock (_intervalProcesses) _intervalProcesses.Remove(processId);
            return true;
        }
        ...
        private static void SetModelStatusThreadSafe(IModelStatus statusObject, ModelStatus status, int operationCount, bool autoSetReadyStatus = true)
        {
            ...
            }), statusObject, status, operationCount, autoSetReadyStatus);
        }

        private static void SetViewActionBusyThreadSafe(IViewAction viewAction, int operationCount)
        {
            if (viewAction == null) return;

            Application.Current.Dispatcher.BeginInvoke(new Action<IViewAction, int>((viewAction2, operationCount2) =>
            {
                lock (viewAction2)
                {
                    viewAction2.BusyOperationsInProgress += operationCount2;
                    if (viewAction2.BusyOperationsInProgress < 0)
                        viewAction2.BusyOperationsInProgress = 0;
                }
            }), viewAction, operationCount);
        }

        private class SchedulerItem
        {
            public SchedulerItem() => LastRun = DateTime.MinValue;
            ...
            public void Run()
            {
                ...
                lock (this) LastRun = DateTime.Now;
            }
            ...
            {
                lock (this) LastRun = DateTime.MinValue;
            }
        }
    ...
    public class MultiExecuteState<TResult>
    {
        ...
        public Func<TResult> Worker { get; }
