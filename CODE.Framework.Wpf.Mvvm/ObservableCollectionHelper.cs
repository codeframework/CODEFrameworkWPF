...
namespace CODE.Framework.Wpf.Mvvm
{
    ...
    public static class ObservableCollectionHelper
    {
        ...
        public static void AddRange<T>(this ObservableCollection<T> collection, IEnumerable<T> itemsToAdd) => collection.AddRange(itemsToAdd.ToList());
        ...
        /// or
        /// Unable to find items collection for observable collection.</exception>
        public static void AddRange<T>(this ObservableCollection<T> collection, IQueryable<T> itemsToAdd) => collection.AddRange(itemsToAdd.ToList());
        ...
        public static void AddRange<T>(this ObservableCollection<T> collection, IList<T> itemsToAdd)
        {
            ...
            if (typeof(ObservableCollection<T>).GetProperty("Items", BindingFlags.Instance | BindingFlags.NonPublic).GetValue(collection, null) is ICollection<T> itemsCollection)
        ...
        {
            if (_synchedCollections == null) return;
            if (source is not IList sourceCollection) return;
            ...
            {
                if (target is not IList targetCollection) continue;
