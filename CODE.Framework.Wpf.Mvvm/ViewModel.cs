...
namespace CODE.Framework.Wpf.Mvvm
{
    ...
    public class ViewModel : IHaveActions, INotifyPropertyChanged, IModelStatus, IHaveViewInformation, IClosable, IOpenable
    {
        ...
        public ModelStatus ModelStatus
        {
            ...
            {
                _modelStatus = value;
                NotifyChanged(nameof(ModelStatus));
            }
        }
        ...
        public void RaiseClosingEvent() => Closing?.Invoke(this, new EventArgs());

        /// <summary>This method can be used to raise the closed event</summary>
        public void RaiseClosedEvent() => Closed?.Invoke(this, new EventArgs());
        ...
        public void RaiseOpeningEvent() => Opening?.Invoke(this, new EventArgs());

        /// <summary>This method can be used to raise the open event</summary>
        public void RaiseOpenedEvent() => Opened?.Invoke(this, new EventArgs());
    }
}