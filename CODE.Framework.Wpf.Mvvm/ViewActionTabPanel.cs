...
namespace CODE.Framework.Wpf.Mvvm
{
    ...
    public class ViewActionTabPanel : TabPanel
    {
        ...
        {
            if (d is not ViewActionTabPanel panel) return;
        ...
        {
            get => (ViewHostTabControl)GetValue(ParentTabControlProperty);
        ...
        {
            if (d is not ViewActionTabPanel panel) return;
            if (args.NewValue is not ViewHostTabControl control) return;
