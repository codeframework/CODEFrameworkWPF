namespace CODE.Framework.Wpf.Mvvm
{
    ...
    public class WindowShellLauncher<TViewHandler> : IViewHandler where TViewHandler : Window, IViewHandler, new()
    {
        ...
        {
            if (context.Result is ShellResult shellResult)
            {
        ...
        /// <returns></returns>
        public bool CloseViewForModel(object model) => false;
        ...
        /// </returns>
        public TModel GetOpenModel<TModel>(Func<TModel, bool> selector) where TModel : class => default;
        ...
        /// A reference to the open model instance
        /// </returns>
        public TModel GetOpenModel<TModel>() where TModel : class => default;
