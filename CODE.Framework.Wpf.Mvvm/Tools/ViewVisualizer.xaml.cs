...
namespace CODE.Framework.Wpf.Mvvm.Tools
{
    ...
    public partial class ViewVisualizer : IViewHandler, INotifyPropertyChanged, IModelStatus
    {
        ...
        public bool OpenView(RequestContext context)
        {
            ...
            if (context.Result is ViewResult viewResult && !viewResult.IsPartial)
            {
        ...
        /// True if successful
        /// </returns>
        public bool ActivateViewForModel(object model) => false;
        ...
        public bool CloseAllViews() => false; // This handler does not handle view closing
        ...
        /// </returns>
        public object GetViewForModel(object model) => null;
        ...
        /// </returns>
        public TModel GetOpenModel<TModel>(Func<TModel, bool> selector) where TModel : class => default(TModel);
        ...
        /// A reference to the open model instance
        /// </returns>
        public TModel GetOpenModel<TModel>() where TModel : class => default(TModel);
        ...
        private void ScaleSlider_MouseDoubleClick(object sender, System.Windows.Input.MouseButtonEventArgs e) => ScaleSlider.Value = 1;
        ...
        private void CheckBox_Checked(object sender, RoutedEventArgs e) => ViewRectangle.Effect = ShadowCheck.IsChecked == true ? new DropShadowEffect() : null;
    ...
    public class ViewVisualizerItem : INotifyPropertyChanged
    {
        ...
        /// Bindable text for the view information
        /// </summary>
        public string ModelText => "Model: " + ModelClass;
        ...
        private static void AddElement(UIElement element, ObservableCollection<UIElementViewModel> collection, UIElement rootView)
        {
            ...
            {
                if (element is Panel childControl)
    ...
    public class ViewModelProperty
    {
        ...
        public Brush Foreground
        {
            get
            {
                ...
                return IsStandardViewModel ? Brushes.Goldenrod : Brushes.Black;
            }
        }
    ...
    public class UIElementViewModel
    {
        ...
        public ObservableCollection<ResourceDictionaryViewModel> ResourceDictionaries
        {
            get
            {
                ...
                if (CurrentView is FrameworkElement currentElement2)
                ...
                if (CurrentView.Equals(UIElement))
                {
                    ...
                    if (UIElement is FrameworkElement currentElement)
        ...
        public ObservableCollection<ControlStyleViewModel> ControlStyles
        {
            get
            {
                ...
                if (UIElement is FrameworkElement currentElement && currentElement.Style != null)
        ...
        public ObservableCollection<ControlPropertyViewModel> ControlProperties
        {
            get
            {
                ...
                if (UIElement is not FrameworkElement currentElement) return new ObservableCollection<ControlPropertyViewModel>();
        ...
        private void PopulateProperties(DependencyObject currentElement, Type elementType, List<ControlPropertyViewModel> properties)
        {
            ...
            {
                if (field.GetValue(currentElement) is not DependencyProperty dependencyProperty) continue;
    ...
    public class ControlPropertyViewModel
    {
        ...
        public Brush Foreground
        {
            get
            {
                ...
                return IsDefault ? Brushes.Gray : Brushes.Black;
            }
        }
