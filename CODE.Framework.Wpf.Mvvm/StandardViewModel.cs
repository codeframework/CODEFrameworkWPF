...
namespace CODE.Framework.Wpf.Mvvm
{
    ...
    public class StandardViewModel : ViewModel, IStandardViewModel
    {
        ...
        public virtual string Identifier1
        {
            ...
            {
                _identifier1 = value;
                NotifyChanged(nameof(Identifier1));
            }
        }
        ...
        public virtual string Identifier2
        {
            ...
            {
                _identifier2 = value;
                NotifyChanged(nameof(Identifier2));
            }
        }
        ...
        public virtual string ToolTipText
        {
            ...
            {
                _toolTipText = value;
                NotifyChanged(nameof(ToolTipText));
            }
        }
        ...
        private void CheckAllBrushesForResources(string propertyName = "")
        {
            ...
            if (!_image1BrushChecked && (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Image1)) && Image1 is DrawingBrush image1)
            {
                ResourceHelper.ReplaceDynamicDrawingBrushResources(image1, brushResources);
                _image1BrushChecked = true;
                NotifyChanged(nameof(Image1));
            }
            if (!_image2BrushChecked && (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Image2)) && Image2 is DrawingBrush image2)
            {
                ResourceHelper.ReplaceDynamicDrawingBrushResources(image2, brushResources);
                _image2BrushChecked = true;
                NotifyChanged(nameof(Image2));
            };
            if (!_image3BrushChecked && (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Image3)) && Image3 is DrawingBrush image3)
            {
            ...
            if (!_image4BrushChecked && (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Image4)) && Image4 is DrawingBrush image4)
            {
                ResourceHelper.ReplaceDynamicDrawingBrushResources(image4, brushResources);
                _image4BrushChecked = true;
                NotifyChanged(nameof(Image4));
            };
            if (!_image5BrushChecked && (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Image5)) && Image5 is DrawingBrush image5)
            {
                ResourceHelper.ReplaceDynamicDrawingBrushResources(image5, brushResources);
                _image5BrushChecked = true;
                NotifyChanged(nameof(Image5));
            };
            if (!_logo1BrushChecked && (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Logo1)) && Logo1 is DrawingBrush logo1)
            {
                ResourceHelper.ReplaceDynamicDrawingBrushResources(logo1, brushResources);
                _logo1BrushChecked = true;
                NotifyChanged(nameof(Logo1));
            };
            if (!_logo2BrushChecked && (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Logo2)) && Logo2 is DrawingBrush logo2)
            {
        ...
        public Brush GetBrushFromResource(string resourceName)
        {
            try
            {
                ...
                if (resource is not Brush brush) return null;
        ...
        /// <param name="sharingContextCollection">Sharing context collection (can be used to differentiate brush context between different subclasses of standard view models).</param>
        public void LoadSharedImage1FromBrushResource(StandardIcons standardIcon, Dictionary<string, Brush> sharingContextCollection = null) => LoadSharedImage1FromBrushResource(StandardIconHelper.GetStandardIconKeyFromEnum(standardIcon), sharingContextCollection);
        ...
        /// <param name="standardIcon">Standard icon to be used as the brush.</param>
        /// <param name="sharingContextCollection">Sharing context collection (can be used to differentiate brush context between different subclasses of standard view models).</param>
        public void LoadSharedImage2FromBrushResource(StandardIcons standardIcon, Dictionary<string, Brush> sharingContextCollection = null) => LoadSharedImage2FromBrushResource(StandardIconHelper.GetStandardIconKeyFromEnum(standardIcon), sharingContextCollection);
        ...
        /// <param name="standardIcon">Standard icon to be used as the brush.</param>
        /// <param name="sharingContextCollection">Sharing context collection (can be used to differentiate brush context between different subclasses of standard view models).</param>
        public void LoadSharedImage3FromBrushResource(StandardIcons standardIcon, Dictionary<string, Brush> sharingContextCollection = null) => LoadSharedImage3FromBrushResource(StandardIconHelper.GetStandardIconKeyFromEnum(standardIcon), sharingContextCollection);
        ...
        /// <param name="standardIcon">Standard icon to be used as the brush.</param>
        /// <param name="sharingContextCollection">Sharing context collection (can be used to differentiate brush context between different subclasses of standard view models).</param>
        public void LoadSharedImage4FromBrushResource(StandardIcons standardIcon, Dictionary<string, Brush> sharingContextCollection = null) => LoadSharedImage4FromBrushResource(StandardIconHelper.GetStandardIconKeyFromEnum(standardIcon), sharingContextCollection);
        ...
        /// <param name="standardIcon">Standard icon to be used as the brush.</param>
        /// <param name="sharingContextCollection">Sharing context collection (can be used to differentiate brush context between different subclasses of standard view models).</param>
        public void LoadSharedImage5FromBrushResource(StandardIcons standardIcon, Dictionary<string, Brush> sharingContextCollection = null) => LoadSharedImage5FromBrushResource(StandardIconHelper.GetStandardIconKeyFromEnum(standardIcon), sharingContextCollection);
        ...
        /// <param name="standardIcon">Standard icon to be used as the brush.</param>
        /// <param name="sharingContextCollection">Sharing context collection (can be used to differentiate brush context between different subclasses of standard view models).</param>
        public void LoadSharedLogo1FromBrushResource(StandardIcons standardIcon, Dictionary<string, Brush> sharingContextCollection = null) => LoadSharedLogo1FromBrushResource(StandardIconHelper.GetStandardIconKeyFromEnum(standardIcon), sharingContextCollection);
        ...
        private static readonly Dictionary<string, Brush> DefaultBrushSharingContextCollection = new();
    }
