...
namespace CODE.Framework.Wpf.Mvvm
{
    ...
    public class PartialView : ContentControl
    {
        ...
        /// <summary>Controller associated with this partial view</summary>
        public static readonly DependencyProperty ControllerProperty = DependencyProperty.Register("Controller", typeof(string), typeof(PartialView), new UIPropertyMetadata("", (d, e) => { if (d is PartialView d2) d2.LoadView(); }));
        ...
        /// <summary>Controller action associated with this partial view</summary>
        public static readonly DependencyProperty ActionProperty = DependencyProperty.Register("Action", typeof(string), typeof(PartialView), new UIPropertyMetadata("", (d, e) => { if (d is PartialView d2) d2.LoadView(); }));
        ...
        /// <summary>Controller action associated with this partial view</summary>
        public static readonly DependencyProperty ViewProperty = DependencyProperty.Register("View", typeof(string), typeof(PartialView), new UIPropertyMetadata("", (d, e) => { if (d is PartialView d2) d2.LoadView(); }));
        ...
        /// <summary>Explicitly set model for the partial view</summary>
        public static readonly DependencyProperty ModelProperty = DependencyProperty.Register("Model", typeof(object), typeof(PartialView), new UIPropertyMetadata(null, (d, e) =>
        {
            if (d is PartialView d2)
                if (d2.Content is FrameworkElement content)
        ...
        /// Parameter to be passed to the view action that is called to load the partial view
        /// </summary>
        public static readonly DependencyProperty ParameterProperty = DependencyProperty.Register("Parameter", typeof(object), typeof(PartialView), new PropertyMetadata(null, (d, e) =>
        {
            if (d is PartialView d2)
                if (d2.Content is FrameworkElement content)
                    content.DataContext = e.NewValue;
        ...
        private void LoadView()
        {
            ...
            if (!string.IsNullOrEmpty(Action))
            {
                ...
                if (context.Result is ViewResult v)
                {
                    Content = v.View;
