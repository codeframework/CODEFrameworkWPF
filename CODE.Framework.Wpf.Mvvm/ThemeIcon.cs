...
namespace CODE.Framework.Wpf.Mvvm
{
    ...
    public class ThemeIcon : Panel
    {
        ...
        private void LoadIcon()
        {
            ...
            if (rawResource is BitmapImage)
                rawResource = new ImageBrush(rawResource as BitmapImage);
        ...
        {
            if (d is not ThemeIcon icon) return;
            icon.LoadIcon();
        }
        ...
        {
            get => (string)GetValue(FallbackIconResourceKeyProperty);
        ...
        {
            get => (bool)GetValue(UseFallbackIconProperty);
        ...
        {
            get => (ObservableResourceDictionary)GetValue(ReplacementBrushesProperty);
        ...
        private static void OnReplacementBrushesChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (e.NewValue is ObservableResourceDictionary dictionary)
