...
namespace CODE.Framework.Wpf.Mvvm
{
    ...
    public class ViewActionsCollection : ObservableCollection<IViewAction>
    {
        ...
        public IViewAction this[string id]
        {
            get
            {
                ...
                if (int.TryParse(id, out var id3))
                    return base[id3];
    ...
    public interface IViewAction : ICommand
    {
        ...
        /// </summary>
        int BusyOperationsInProgress { get; set; }
    }
    ...
    public class ViewActionCategory : IComparable, INotifyPropertyChanged
    {
        ...
        {
            get => _isLocalCategory;
            set
            {
                _isLocalCategory = value;
                NotifyChanged(nameof(IsLocalCategory));
            }
        }
        ...
        public char AccessKey
        {
            ...
            {
                _accessKey = value;
                NotifyChanged(nameof(AccessKey));
            }
        }
        ...
        {
            get => _brushResourceKey;
            set
            {
                _brushResourceKey = value;
                NotifyChanged(nameof(BrushResourceKey));
            }
        }
        ...
        {
            if (obj is not ViewActionCategory otherCategory) return 0; // Nothing else we can do, really.
    ...
    public class ViewAction : IViewAction, INotifyPropertyChanged, IStandardViewModel
    {
        ...
        public override string ToString() => $"{base.ToString()} ({Caption})";
        ...
        {
            get => _visualResourceKey;
            set
            {
                _visualResourceKey = value;
                _latestBrush = null;
                NotifyChanged(nameof(VisualResourceKey));
                NotifyChanged(nameof(Visual));
                NotifyChanged(nameof(Brush));
                NotifyChanged(nameof(PopulatedBrush));
                NotifyChanged(nameof(PopulatedVisual));
            }
        }
        ...
        public string BrushResourceKey
        {
            ...
            set
            {
                ...
                _latestBrush = null;
                NotifyChanged(nameof(BrushResourceKey));
                NotifyChanged(nameof(CategoryBrushResourceKey));
                NotifyChanged(nameof(Visual));
                NotifyChanged(nameof(Brush));
                NotifyChanged(nameof(PopulatedBrush));
                NotifyChanged(nameof(PopulatedVisual));
                NotifyChanged(nameof(Image1));
            }
        }
        ...
        public StandardIcons StandardIcon
        {
            ...
            {
                _standardIcon = value;
                NotifyChanged(nameof(StandardIcon));
        ...
        {
            get => string.IsNullOrEmpty(_categoryBrushResourceKey) ? BrushResourceKey : _categoryBrushResourceKey;
            set
            {
        ...
        {
            get => _logoBrushResourceKey;
            set
            {
                _logoBrushResourceKey = value;
                _latestLogoBrush = null;
                NotifyChanged(nameof(LogoBrushResourceKey));
                NotifyChanged(nameof(Logo1));
            }
        }
        ...
        public Brush GetBrushFromResource(string resourceName)
        {
            ...
            return resource is not Brush brush ? null : brush.Clone();
        }
                ...
                try
                {
                    ...
                    if (!string.IsNullOrEmpty(brushResourceKey))
                    {
                        ...
                        if (ActionView != null)
                        {
                            ...
                            if (resourceSearchContext is StandardViewGrid standardGrid && standardGrid.Children.Count > 0)
                                if (standardGrid.Children[0] is FrameworkElement firstChild)
                                {
                        ...
                        if (brushResources.Count > 0 && icon is DrawingBrush drawing) // We may have some resources we need to replace
        ...
        public bool HasBrush => !string.IsNullOrEmpty(BrushResourceKey);
        ...
        public Brush PopulatedBrush
        {
            get
            {
                try
                {
                    if (!string.IsNullOrEmpty(BrushResourceKey)) return Brush;
                    _latestBrush = null;
        ...
        /// <summary>This property is mostly used internally only. It can be used to set objects that provide resource dictionaries which can then be considered for brush resources</summary>
        /// <value>The resource context object.</value>
        public object ResourceContextObject
        {
            get => _resourceContextObject;
            set
            {
        ...
        /// <returns></returns>
        public bool CanExecute(object parameter) => !IsBusy && (_canExecuteDelegate == null || _canExecuteDelegate(this, parameter));
        ...
        public void InvalidateCanExecute()
        {
            ...
            NotifyChanged(nameof(CanExecuteVisibility));
        }

        /// <summary>
        /// Indicates whether the action is currently busy (and thus cannot execute)
        /// </summary>
        public bool IsBusy => BusyOperationsInProgress > 0;
        ...
        {
            get => _busyOperationsInProgress;
            set
            {
                _busyOperationsInProgress = value;
        ...
        /// </summary>
        public Visibility CanExecuteVisibility => CanExecute(null) ? Visibility.Visible : Visibility.Collapsed;
        ...
        protected void SetExecutionDelegate(Action<IViewAction, object> method) => _executeDelegate = method;

        /// <summary>
        /// Sets a method as the delegate for can execute
        /// </summary>
        /// <param name="method"></param>
        protected void SetCanExecuteDelegate(Func<IViewAction, object, bool> method) => _canExecuteDelegate = method;
        ...
        public bool HasExecuteDelegate => _executeDelegate != null;
        ...
        private void ExecuteQueue()
        {
            lock (_executionQueue)
                while (_executionQueue.Count > 0)
                {
                    ...
                    nextItem.Execute?.Invoke(nextItem.Source, nextItem.Parameter);
                }
        }
        ...
        public bool IsChecked
        {
            ...
            {
                _isChecked = value;
                NotifyChanged(nameof(IsChecked));
                NotifyChanged(nameof(IsChecked_Visible));
            }
        }
        ...
        {
            get => IsChecked ? Visibility.Visible : Visibility.Collapsed;
        ...
        public ViewActionTypes ViewActionType
        {
            ...
            set
            {
                ...
                NotifyChanged(nameof(ViewActionType));
            }
        }
            ...
            get
            {
                if (_availability == ViewActionAvailabilities.Unknown)
                {
                    if (UserRoles.Length == 0)
                        _availability = ViewActionAvailabilities.Available;
                    else
                    {
                        ...
                        {
                            lock (this) _availability = a;
                            NotifyChanged(nameof(Availability));
                        });
                    }
                }
        ...
        public Visibility Visibility
        {
            ...
            {
                _visibility = value;
                NotifyChanged(nameof(Visibility));
            }
        }
        ...
        private int _busyOperationsInProgress;
        ...
        private void CheckAllBrushesForResources()
        {
            ...
            if (Image1 is DrawingBrush image1)
            {
                ResourceHelper.ReplaceDynamicDrawingBrushResources(image1, brushResources);
                NotifyChanged(nameof(Image1));
            }
            if (Image2 is DrawingBrush image2)
            {
                ResourceHelper.ReplaceDynamicDrawingBrushResources(image2, brushResources);
                NotifyChanged(nameof(Image2));
            }
            if (Image3 is DrawingBrush image3)
            {
                ResourceHelper.ReplaceDynamicDrawingBrushResources(image3, brushResources);
                NotifyChanged(nameof(Image3));
            }
            if (Image4 is DrawingBrush image4)
            {
                ResourceHelper.ReplaceDynamicDrawingBrushResources(image4, brushResources);
                NotifyChanged(nameof(Image4));
            }
            if (Image5 is DrawingBrush image5)
            {
                ResourceHelper.ReplaceDynamicDrawingBrushResources(image5, brushResources);
                NotifyChanged(nameof(Image5));
            }
            if (Logo1 is DrawingBrush logo1)
            {
                ResourceHelper.ReplaceDynamicDrawingBrushResources(logo1, brushResources);
                NotifyChanged(nameof(Logo1));
            }
            if (Logo2 is DrawingBrush logo2)
            {
                ResourceHelper.ReplaceDynamicDrawingBrushResources(logo2, brushResources);
                NotifyChanged(nameof(Logo2));
            }
    ...
    public class DependencyViewActionWrapper : DependencyObject, IViewAction, INotifyPropertyChanged, IStandardViewModel
    {
        ...
        public DependencyViewActionWrapper(IViewAction wrappedAction)
        {
            ...
            if (wrappedAction is INotifyPropertyChanged inpf)
                inpf.PropertyChanged += (s, e) =>
                {
                    PropertyChanged?.Invoke(s, e);
                    PopulateLocalPropertiesFromRealViewAction(e.PropertyName);
                };
            _wrappedAction.CanExecuteChanged += (s, e) => CanExecuteChanged?.Invoke(s, e);
        ...
        private void PopulateLocalPropertiesFromRealViewAction(string propertyName = "")
        {
            ...
            _inLocalUpdate = true;
            if (_wrappedAction is IStandardViewModel standardViewModel)
            {
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Text1)) Text1 = standardViewModel.Text1;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Text2)) Text2 = standardViewModel.Text2;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Text3)) Text3 = standardViewModel.Text3;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Text4)) Text4 = standardViewModel.Text4;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Text5)) Text5 = standardViewModel.Text5;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Text6)) Text6 = standardViewModel.Text6;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Text7)) Text7 = standardViewModel.Text7;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Text8)) Text8 = standardViewModel.Text8;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Text9)) Text9 = standardViewModel.Text9;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Text10)) Text10 = standardViewModel.Text10;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Identifier1)) Identifier1 = standardViewModel.Identifier1;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Identifier2)) Identifier2 = standardViewModel.Identifier2;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Number1)) Number1 = standardViewModel.Number1;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Number2)) Number2 = standardViewModel.Number2;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(ToolTipText)) ToolTipText = standardViewModel.ToolTipText;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Image1)) Image1 = standardViewModel.Image1;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Image2)) Image2 = standardViewModel.Image2;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Image3)) Image3 = standardViewModel.Image3;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Image4)) Image4 = standardViewModel.Image4;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Image5)) Image5 = standardViewModel.Image5;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Logo1)) Logo1 = standardViewModel.Logo1;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Logo2)) Logo2 = standardViewModel.Logo2;
            }

            if (_wrappedAction is ViewAction action)
            {
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(IsLocalAction)) IsLocalAction = action.IsLocalAction;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(IsChecked_Visible)) IsChecked_Visible = action.IsChecked_Visible;
            }

            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Id)) Id = _wrappedAction.Id;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Caption)) Caption = _wrappedAction.Caption;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(BeginGroup)) BeginGroup = _wrappedAction.BeginGroup;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(GroupTitle)) GroupTitle = _wrappedAction.GroupTitle;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(IsCancel)) IsCancel = _wrappedAction.IsCancel;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(IsChecked)) IsChecked = _wrappedAction.IsChecked;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(IsDefault)) IsDefault = _wrappedAction.IsDefault;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(IsDefaultSelection)) IsDefaultSelection = _wrappedAction.IsDefaultSelection;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(IsPinned)) IsPinned = _wrappedAction.IsPinned;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(ViewActionType)) ViewActionType = _wrappedAction.ViewActionType;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Availability)) Availability = _wrappedAction.Availability;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Visibility)) Visibility = _wrappedAction.Visibility;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Significance))
            {
            ...
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Categories)) Categories = _wrappedAction.Categories;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(CategoryOrder)) CategoryOrder = _wrappedAction.CategoryOrder;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Order)) Order = _wrappedAction.Order;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(FirstCategoryId)) FirstCategoryId = _wrappedAction.FirstCategoryId;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(ActionViewModel)) ActionViewModel = _wrappedAction.ActionViewModel;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(ActionView)) ActionView = _wrappedAction.ActionView;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(UserRoles)) UserRoles = _wrappedAction.UserRoles;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(AccessKey)) AccessKey = _wrappedAction.AccessKey;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(ShortcutKey)) ShortcutKey = _wrappedAction.ShortcutKey;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(ShortcutModifiers)) ShortcutModifiers = _wrappedAction.ShortcutModifiers;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(IsBusy)) IsBusy = _wrappedAction.IsBusy;
        ...
        {
            if (!(o is DependencyViewActionWrapper wrapper)) return;
        ...
        private void UpdateViewActionFromLocalProperties(string propertyName = "")
        {
            ...
            if (_wrappedAction is IStandardViewModel standardViewModel)
            {
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Text1)) standardViewModel.Text1 = Text1;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Text2)) standardViewModel.Text2 = Text2;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Text3)) standardViewModel.Text3 = Text3;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Text4)) standardViewModel.Text4 = Text4;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Text5)) standardViewModel.Text5 = Text5;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Text6)) standardViewModel.Text6 = Text6;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Text7)) standardViewModel.Text7 = Text7;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Text8)) standardViewModel.Text8 = Text8;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Text9)) standardViewModel.Text9 = Text9;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Text10)) standardViewModel.Text10 = Text10;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Identifier1)) standardViewModel.Identifier1 = Identifier1;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Identifier2)) standardViewModel.Identifier2 = Identifier2;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Number1)) standardViewModel.Number1 = Number1;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Number2)) standardViewModel.Number2 = Number2;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(ToolTipText)) standardViewModel.ToolTipText = ToolTipText;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Image1)) standardViewModel.Image1 = Image1;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Image2)) standardViewModel.Image2 = Image2;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Image3)) standardViewModel.Image3 = Image3;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Image4)) standardViewModel.Image4 = Image4;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Image5)) standardViewModel.Image5 = Image5;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Logo1)) standardViewModel.Logo1 = Logo1;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Logo2)) standardViewModel.Logo2 = Logo2;
            }

            if (_wrappedAction is ViewAction action)
            {
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(IsLocalAction)) action.IsLocalAction = IsLocalAction;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(IsChecked_Visible)) action.IsChecked_Visible = IsChecked_Visible;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(CategoryOrder)) action.CategoryOrder = CategoryOrder;
                if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Order)) action.Order = Order;
            }

            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Id)) _wrappedAction.Id = Id;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Caption)) _wrappedAction.Caption = Caption;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(BeginGroup)) _wrappedAction.BeginGroup = BeginGroup;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(GroupTitle)) _wrappedAction.GroupTitle = GroupTitle;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(IsCancel)) _wrappedAction.IsCancel = IsCancel;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(IsChecked)) _wrappedAction.IsChecked = IsChecked;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(IsDefault)) _wrappedAction.IsDefault = IsDefault;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(IsDefaultSelection)) _wrappedAction.IsDefaultSelection = IsDefaultSelection;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(IsPinned)) _wrappedAction.IsPinned = IsPinned;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(ViewActionType)) _wrappedAction.ViewActionType = ViewActionType;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Visibility)) _wrappedAction.Visibility = Visibility;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Significance)) _wrappedAction.Significance = Significance;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(Categories)) _wrappedAction.Categories = Categories;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(ActionViewModel)) _wrappedAction.ActionViewModel = ActionViewModel;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(ActionView)) _wrappedAction.ActionView = ActionView;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(UserRoles)) _wrappedAction.UserRoles = UserRoles;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(AccessKey)) _wrappedAction.AccessKey = AccessKey;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(ShortcutKey)) _wrappedAction.ShortcutKey = ShortcutKey;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(ShortcutModifiers)) _wrappedAction.ShortcutModifiers = ShortcutModifiers;
            if (string.IsNullOrEmpty(propertyName) || propertyName == nameof(BusyOperationsInProgress)) _wrappedAction.BusyOperationsInProgress = BusyOperationsInProgress;
        ...
        public string Text6
        {
            get => (string)GetValue(Text6Property);
        ...
        public string Text7
        {
            get => (string)GetValue(Text7Property);
        ...
        public string Text8
        {
            get => (string)GetValue(Text8Property);
        ...
        public string Text9
        {
            get => (string)GetValue(Text9Property);
        ...
        {
            get => (string)GetValue(Text10Property);
        ...
        {
            get => (string)GetValue(Identifier1Property);
        ...
        {
            get => (string)GetValue(Identifier2Property);
        ...
        public Brush Image1
        {
            get => (Brush)GetValue(Image1Property);
        ...
        public Brush Image2
        {
            get => (Brush)GetValue(Image2Property);
        ...
        public Brush Image3
        {
            get => (Brush)GetValue(Image3Property);
        ...
        public Brush Image4
        {
            get => (Brush)GetValue(Image4Property);
        ...
        public Brush Image5
        {
            get => (Brush)GetValue(Image5Property);
        ...
        public Brush Logo1
        {
            get => (Brush)GetValue(Logo1Property);
        ...
        public Brush Logo2
        {
            get => (Brush)GetValue(Logo2Property);
        ...
        {
            get => (bool)GetValue(BeginGroupProperty);
        ...
        {
            get => (bool)GetValue(IsDefaultSelectionProperty);
        ...
        {
            get => (bool)GetValue(IsLocalActionProperty);
        ...
        public ViewActionTypes ViewActionType
        {
            get => (ViewActionTypes)GetValue(ViewActionTypeProperty);
        ...
        public ViewActionAvailabilities Availability
        {
            get => (ViewActionAvailabilities)GetValue(AvailabilityProperty);
        ...
        public Visibility IsChecked_Visible
        {
            get => (Visibility)GetValue(IsChecked_VisibleProperty);
        ...
        {
            get => (List<ViewActionCategory>)GetValue(CategoriesProperty);
        ...
        public string FirstCategoryId
        {
            get => (string)GetValue(FirstCategoryIdProperty);
        ...
        {
            get => GetValue(ActionViewModelProperty);
        ...
        {
            get => (FrameworkElement)GetValue(ActionViewProperty);
        ...
        {
            get => (string[])GetValue(UserRolesProperty);
        ...
        /// </summary>
        /// <remarks>This method should simply fire the CanExecuteChanged event.</remarks>
        public void InvalidateCanExecute() => _wrappedAction.InvalidateCanExecute();

        /// <summary>
        /// Indicates whether the action is currently busy (and thus cannot execute)
        /// </summary>
        public static readonly DependencyProperty IsBusyProperty = DependencyProperty.Register("IsBusy", typeof(bool), typeof(DependencyViewActionWrapper), new PropertyMetadata(false, (o, args) => UpdateViewActionFromLocalProperties(o, "Busy")));
        ...
        /// Indicates how many operations are currently in progress. If it's greater than 0, then the IsBusy flag will should true
        /// </summary>
        public static readonly DependencyProperty BusyOperationsInProgressProperty = DependencyProperty.Register("BusyOperationsInProgress", typeof(int), typeof(DependencyViewActionWrapper), new PropertyMetadata(0, (o, args) => UpdateViewActionFromLocalProperties(o, "Busy")));
        ...
        public int BusyOperationsInProgress
        {
            get => (int)GetValue(BusyOperationsInProgressProperty);
            set
            {
                SetValue(BusyOperationsInProgressProperty, value);
                InvalidateCanExecute();
            }
        }
        ...
        public bool CanExecute(object parameter) => _wrappedAction.CanExecute(parameter);
        ...
        /// </summary>
        /// <param name="parameter">Data used by the command.  If the command does not require data to be passed, this object can be set to null.</param>
        public void Execute(object parameter) => _wrappedAction.Execute(parameter);
    }
    ...
    public class Closable : DependencyObject
    {
        ...
        /// </summary>
        public static bool GetRaiseClosingEvents(DependencyObject d) => (bool)d.GetValue(RaiseClosingEventsProperty);
        ...
        public static void SetRaiseClosingEvents(DependencyObject d, bool value) => d.SetValue(RaiseClosingEventsProperty, value);
        ...
        private static void OnRaiseClosingEventsChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!(window.DataContext is IClosable closable)) return;

            window.Closing += (s, e2) =>
            {
                if (!(s is Window window2)) return;
                if (!(window2.DataContext is IClosable closable2)) return;
