...
namespace CODE.Framework.Wpf.Mvvm
{
    ...
    public class ViewActionAndOpenViewSelector : ItemsControl
    {
        ...
        {
            get => (IHaveActions)GetValue(ActionsProperty);
        ...
        {
            if (d is not ViewActionAndOpenViewSelector selector) return;
            selector.Repopulate();
            if (args.NewValue is not IHaveActions actions) return;
        ...
        {
            get => (IEnumerable<ViewResult>)GetValue(ViewsProperty);
        ...
        {
            get => (TabControl)GetValue(ViewTabsProperty);
        ...
        private static void OnViewsChanged(DependencyObject d, DependencyPropertyChangedEventArgs args)
        {
            ...
            if (args.NewValue is ObservableCollection<ViewResult> observable)
        ...
        private static void OnTriggerItemChanged(DependencyObject d, DependencyPropertyChangedEventArgs args)
        {
            ...
            if (args.NewValue is not ViewActionAndOpenViewItem item) return;
        ...
        public static void SetTriggerItem(DependencyObject d, ViewActionAndOpenViewItem value) => d.SetValue(TriggerItemProperty, value);
        /// <summary>
        /// Getting the trigger item
        /// </summary>
        /// <param name="d">The d.</param>
        /// <returns>ViewActionAndOpenViewItem.</returns>
        public static ViewActionAndOpenViewItem GetTriggerItem(DependencyObject d) => (ViewActionAndOpenViewItem)d.GetValue(TriggerItemProperty);
    ...
    public class ViewActionAndOpenViewItem : DependencyObject, INotifyPropertyChanged
    {
        ...
        {
            get => (int)GetValue(MaxSubItemCountProperty);
        ...
        {
            if (d is not ViewActionAndOpenViewItem item) return;
        ...
        public string OpenSubItemDisplayCount
        {
            get
            {
                ...
                return MaxSubItemCount > -1 && count > MaxSubItemCount ? "+" : count.ToString(CultureInfo.InvariantCulture);
            }
        }
        ...
        public string Caption
        {
            get
            {
                ...
                return View != null ? View.ViewTitle : string.Empty;
            }
        }
        ...
        /// Icon
        /// </summary>
        public Brush Icon => Action != null ? Action is ViewAction viewAction ? viewAction.PopulatedBrush : null : (global::System.Windows.Media.Brush)null;
        ...
        protected virtual void NotifyChanged(string property = "") => PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(property));
    }
