...
// TODO: This test does not appear to be working right
...
namespace CODE.Framework.Wpf.TestBench
{
    ...
    public partial class RibbonTest : Window
    {
        public RibbonTest()
        {
            ...
            InitializeComponent();
            var ribbonModel = new RibbonData();
            //ribbon.Model = ribbonModel;
            toolbar.Actions = ribbonModel.Actions;
        }
    }
    ...
    public class RibbonData : IHaveActions
    {
        public RibbonData()
        {
            Actions = new ViewActionsCollection
            {
                ...
                new ViewAction("Enable/Disable", beginGroup: true, category: "Page 2", execute: (s, e) => Actions["Two B"].InvalidateCanExecute()) {Significance = ViewActionSignificance.AboveNormal, BrushResourceKey = "CODE.Framework-Icon-Read"},
