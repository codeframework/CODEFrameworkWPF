...
using CODE.Framework.Wpf.Theme.Universe.StandardViews;

namespace CODE.Framework.Wpf.Theme.Universe.Classes
{
    /// <summary>
    /// Standard features supported by the Workplace theme
    /// </summary>
    public class UniverseStandardFeatures : IThemeStandardFeatures
    {
        ...
        private readonly IStandardViewFactory _standardViewFactory = new UniverseStandardViewFactory();
    }

    /// <summary>Factory to create standard views supported by Workplace</summary>
    public class UniverseStandardViewFactory : IStandardViewFactory
    {
        ...
        public FrameworkElement GetStandardView(string viewName)
        {
            ...
            switch (viewName)
            {
                ...
                case "LargePeekImageAndText06": return new ListBoxSmartDataTemplate { DefaultColumns = "Image1, Text1, Text2, Text3" };
