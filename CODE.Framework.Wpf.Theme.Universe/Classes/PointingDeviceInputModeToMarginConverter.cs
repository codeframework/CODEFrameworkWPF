...
namespace CODE.Framework.Wpf.Theme.Universe.Classes
{
    ...
    public class PointingDeviceInputModeToMarginConverter : IValueConverter
    {
        ...
        /// </summary>
        public Thickness MouseMargin { get; set; } = new Thickness();

        /// <summary>
        /// Margin to be used when the mode is set to Touch
        /// </summary>
        public Thickness TouchMargin { get; set; } = new Thickness();
        ...
        public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture) => value; // Not needed
    }
}
