...
namespace CODE.Framework.Wpf.Theme.Universe.Controls
{
    ...
    public class ShellTabControl : TabControl
    {
        ...
        public override void OnApplyTemplate()
        {
            ...
            if (Template.FindName("HeaderPanel", this) is UIElement headers)
            ...
            if (Template.FindName("HomePanel", this) is UIElement home)
        ...
        private void HidePages() => SelectedIndex = -1;
        ...
        {
            get => (string)GetValue(HomeTitleProperty);
        ...
        {
            get => (bool)GetValue(HomePageVisibleProperty);
        ...
        {
            get => (UIElement)GetValue(HomePageProperty);
