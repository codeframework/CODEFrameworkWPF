...
namespace CODE.Framework.Wpf.Theme.Workplace.Classes
{
    ...
    public class ScrollRightButton : RepeatButton
    {
        ...
        /// </summary>
        public ScrollRightButton() => IsEnabled = false;
        ...
        {
            if (d is not ScrollRightButton button || e.NewValue is not ScrollViewer scroll) return;
    ...
    public class ScrollLeftButton : RepeatButton
    {
        ...
        /// </summary>
        public ScrollLeftButton() => IsEnabled = false;
        ...
        private static void ScrollViewerChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            if (d is not ScrollLeftButton button || e.NewValue is not ScrollViewer scroll) return;
