...
namespace CODE.Framework.Wpf.Theme.Metro.Controls
{
    ...
    public class SizeAwareContentControl : ContentControl
    {
        ...
        {
            get => (Thickness)GetValue(MaximumMarginProperty);
        ...
        {
            if (source is SizeAwareContentControl contentControl) contentControl.CalculateMargin();
        }

        /// <summary>Minimum margin allowed around the control</summary>
        public Thickness MinimumMargin
        {
            get => (Thickness)GetValue(MinimumMarginProperty);
        ...
        {
            get => (Size)GetValue(MinimumDesiredControlSizeProperty);
