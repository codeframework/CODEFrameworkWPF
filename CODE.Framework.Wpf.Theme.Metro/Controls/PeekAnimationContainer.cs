...
namespace CODE.Framework.Wpf.Theme.Metro.Controls
{
    ...
    public class PeekAnimationContainer : Grid
    {
        ...
        {
            get => (UIElement)GetValue(ContentTopProperty);
        ...
        {
            get => (UIElement)GetValue(ContentBottomProperty);
        ...
        {
            get => (double)GetValue(VerticalSlideProperty);
        ...
        {
            get => (int)GetValue(TopContentDisplayDurationProperty);
        ...
        {
            get => (int)GetValue(BottomContentDisplayDurationProperty);
        ...
        {
            get => (int)GetValue(ContentTransitionDurationProperty);
        ...
        {
            get => (int)GetValue(AnimationStartDelayProperty);
        ...
        {
            get => (int)GetValue(AnimationStartDelayRandomAdditionProperty);
        ...
        {
            get => (int)GetValue(TopContentDisplayDurationRandomAdditionProperty);
        ...
        {
            get => (int)GetValue(BottomContentDisplayDurationRandomAdditionProperty);
        ...
        {
            get => (bool)GetValue(StartWithTopContentProperty);
        ...
        {
            if (s is PeekAnimationContainer peek) peek.PopulateChildren();
        }
