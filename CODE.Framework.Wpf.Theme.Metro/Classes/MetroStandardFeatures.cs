...
using CODE.Framework.Wpf.Theme.Metro.StandardViews;
...
namespace CODE.Framework.Wpf.Theme.Metro.Classes
{
    ...
    /// </summary>
    public class MetroStandardFeatures : IThemeStandardFeatures
    {
        ...
        private readonly IStandardViewFactory _standardViewFactory = new MetroStandardViewFactory();
    }

    /// <summary>Factory to create standard views supported by Metro</summary>
    public class MetroStandardViewFactory : IStandardViewFactory
    {
        ...
        public FrameworkElement GetStandardView(string viewName)
        {
            ...
            switch (viewName)
            {
                ...
                case "Image": return new StandardViews.Image();
